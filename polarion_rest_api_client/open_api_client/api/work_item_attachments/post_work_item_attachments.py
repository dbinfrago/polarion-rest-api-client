...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/workitems/{work_item_id}/attachments".format(
...
) -> Errors | WorkitemAttachmentsListPostResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | WorkitemAttachmentsListPostResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | WorkitemAttachmentsListPostResponse
    """
