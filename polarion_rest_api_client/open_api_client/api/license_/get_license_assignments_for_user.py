...
from ...models.license_assignments_single_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/license/assignments/{user_id}".format(
...
) -> Errors | LicenseAssignmentsSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = LicenseAssignmentsSingleGetResponse.from_dict(
            response.json()
        )
