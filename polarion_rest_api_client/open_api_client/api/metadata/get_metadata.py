...
from ...models.metadata_single_get_response import MetadataSingleGetResponse
...
) -> Errors | MetadataSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = MetadataSingleGetResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Returns global metadata, including version, build, REST API configuration properties, etc.
    (Available to all REST API users.)
