...
from ...models.document_comments_list_get_response import (
...
) -> Union[DocumentCommentsListGetResponse, Errors] | None:
    if response.status_code == 200:
        response_200 = DocumentCommentsListGetResponse.from_dict(
            response.json()
        )
