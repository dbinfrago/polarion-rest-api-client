...
from ...models.testrun_attachments_list_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/testruns/{test_run_id}/attachments".format(
...
) -> Errors | TestrunAttachmentsListGetResponse | None:
    if response.status_code == 200:
        response_200 = TestrunAttachmentsListGetResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | TestrunAttachmentsListGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | TestrunAttachmentsListGetResponse
    """
