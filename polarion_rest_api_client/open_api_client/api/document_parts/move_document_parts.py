...
from ...models.move_document_part_request_body import (
...
def _get_kwargs(
    ...
    part_id: str,
    *,
    body: MoveDocumentPartRequestBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/spaces/{space_id}/documents/{document_name}/parts/{part_id}/actions/move".format(
