...
from ...models.document_parts_list_post_request import (
    DocumentPartsListPostRequest,
)
from ...models.document_parts_list_post_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/spaces/{space_id}/documents/{document_name}/parts".format(
