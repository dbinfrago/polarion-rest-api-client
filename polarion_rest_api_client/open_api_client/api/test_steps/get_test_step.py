...
from ...models.teststeps_single_get_response import TeststepsSingleGetResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/workitems/{work_item_id}/teststeps/{test_step_index}",
        "params": params,
    }
...
) -> Union[Errors, TeststepsSingleGetResponse] | None:
    if response.status_code == 200:
        response_200 = TeststepsSingleGetResponse.from_dict(response.json())
