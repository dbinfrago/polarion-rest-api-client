...
from ...models.testrecord_attachments_list_get_response import (
...
) -> Union[Errors, TestrecordAttachmentsListGetResponse] | None:
    if response.status_code == 200:
        response_200 = TestrecordAttachmentsListGetResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Errors, TestrecordAttachmentsListGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Errors, TestrecordAttachmentsListGetResponse]
    """
