...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/spaces/{space_id}/documents/{document_name}/attachments/{attachment_id}",
        "params": params,
    }
...
) -> Union[DocumentAttachmentsSingleGetResponse, Errors] | None:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DocumentAttachmentsSingleGetResponse, Errors]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DocumentAttachmentsSingleGetResponse, Errors]
    """
