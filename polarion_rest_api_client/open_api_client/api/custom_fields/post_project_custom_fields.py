...
from ...models.customfields_list_post_request import (
    CustomfieldsListPostRequest,
)
from ...models.customfields_list_post_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/customfields".format(
...
) -> CustomfieldsListPostResponse | Errors | None:
    if response.status_code == 201:
        response_201 = CustomfieldsListPostResponse.from_dict(response.json())
