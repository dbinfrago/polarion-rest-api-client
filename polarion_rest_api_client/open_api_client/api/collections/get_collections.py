...
from ...models.collections_list_get_response import CollectionsListGetResponse
...
) -> Union[CollectionsListGetResponse, Errors] | None:
    if response.status_code == 200:
        response_200 = CollectionsListGetResponse.from_dict(response.json())
