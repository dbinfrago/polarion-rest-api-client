...
from ...models.externallylinkedworkitems_list_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/workitems/{work_item_id}/externallylinkedworkitems".format(
...
) -> Errors | ExternallylinkedworkitemsListGetResponse | None:
    if response.status_code == 200:
        response_200 = ExternallylinkedworkitemsListGetResponse.from_dict(
            response.json()
        )
