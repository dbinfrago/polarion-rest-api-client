...
from ...models.testrun_comments_list_get_response import (
...
) -> Union[Errors, TestrunCommentsListGetResponse] | None:
    if response.status_code == 200:
        response_200 = TestrunCommentsListGetResponse.from_dict(
            response.json()
        )
