...
from ...models.testrun_comments_single_patch_request import (
...
def _get_kwargs(
    ...
    comment_id: str,
    *,
    body: TestrunCommentsSinglePatchRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/projects/{project_id}/testruns/{test_run_id}/comments/{comment_id}".format(
