...
from ...models.page_comments_list_get_response import (
...
) -> Errors | PageCommentsListGetResponse | None:
    if response.status_code == 200:
        response_200 = PageCommentsListGetResponse.from_dict(response.json())
