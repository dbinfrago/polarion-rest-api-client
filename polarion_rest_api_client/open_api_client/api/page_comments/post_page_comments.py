...
from ...models.page_comments_list_post_request import (
    PageCommentsListPostRequest,
)
from ...models.page_comments_list_post_response import (
...
def _get_kwargs(
    ...
    page_name: str,
    *,
    body: PageCommentsListPostRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/spaces/{space_id}/pages/{page_name}/comments".format(
...
) -> Errors | PageCommentsListPostResponse | None:
    if response.status_code == 201:
        response_201 = PageCommentsListPostResponse.from_dict(response.json())
