...
from ...models.workitems_single_get_response import WorkitemsSingleGetResponse
...
) -> Union[Errors, WorkitemsSingleGetResponse] | None:
    if response.status_code == 200:
        response_200 = WorkitemsSingleGetResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Errors, WorkitemsSingleGetResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Errors, WorkitemsSingleGetResponse]
    """
