...
from ...models.move_work_items_to_document_request_body import (
...
def _get_kwargs(
    project_id: str,
    *,
    body: MoveWorkItemsToDocumentRequestBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/workitems/actions/moveToDocument".format(
