...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/workitems/{work_item_id}/testparameterdefinitions/{test_param_id}".format(
            project_id=quote(str(project_id), safe=""),
            work_item_id=quote(str(work_item_id), safe=""),
            test_param_id=quote(str(test_param_id), safe=""),
        ),
        "params": params,
    }
...
) -> Errors | TestparameterDefinitionsSingleGetResponse | None:
