...
from ...models.workitem_approvals_list_post_request import (
    WorkitemApprovalsListPostRequest,
)
from ...models.workitem_approvals_list_post_response import (
...
def _get_kwargs(
    ...
    work_item_id: str,
    *,
    body: WorkitemApprovalsListPostRequest,
) -> dict[str, Any]:
...
) -> Union[Errors, WorkitemApprovalsListPostResponse] | None:
    if response.status_code == 201:
        response_201 = WorkitemApprovalsListPostResponse.from_dict(
            response.json()
        )
