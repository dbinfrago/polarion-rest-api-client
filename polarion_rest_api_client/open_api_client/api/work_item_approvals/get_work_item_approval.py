...
from ...models.workitem_approvals_single_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/workitems/{work_item_id}/approvals/{user_id}",
        "params": params,
    }
...
) -> Union[Errors, WorkitemApprovalsSingleGetResponse] | None:
    if response.status_code == 200:
        response_200 = WorkitemApprovalsSingleGetResponse.from_dict(
            response.json()
        )
