...
from ...models.plans_single_get_response import PlansSingleGetResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/plans/{plan_id}",
        "params": params,
    }
...
) -> Union[Errors, PlansSingleGetResponse] | None:
    if response.status_code == 200:
        response_200 = PlansSingleGetResponse.from_dict(response.json())
