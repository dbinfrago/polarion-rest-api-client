...
from ...models.plans_list_post_request import PlansListPostRequest
...
def _get_kwargs(
    project_id: str,
    *,
    body: PlansListPostRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/projects/{project_id}/plans",
    }
...
) -> Union[Errors, PlansListPostResponse] | None:
