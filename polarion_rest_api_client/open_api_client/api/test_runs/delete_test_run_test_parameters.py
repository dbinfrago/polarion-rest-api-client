...
from ...models.testparameters_list_delete_request import (
...
def _get_kwargs(
    ...
    test_run_id: str,
    *,
    body: TestparametersListDeleteRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/projects/{project_id}/testruns/{test_run_id}/testparameters".format(
