...
from ...models.testruns_single_get_response import TestrunsSingleGetResponse
...
) -> Errors | TestrunsSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = TestrunsSingleGetResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | TestrunsSingleGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | TestrunsSingleGetResponse
    """
