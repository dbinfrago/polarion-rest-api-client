...
from ...models.patch_test_step_result_attachments_request_body import (
...
def _get_kwargs(
    ...
    attachment_id: str,
    *,
    body: PatchTestStepResultAttachmentsRequestBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    r"""Updates the specified Test Step Result Attachment.
    ...
    Args:
        ...
        test_step_index (str):
        attachment_id (str):
        body (PatchTestStepResultAttachmentsRequestBody | Unset):
