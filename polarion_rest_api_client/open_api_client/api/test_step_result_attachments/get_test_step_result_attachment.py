...
from ...models.teststepresult_attachments_single_get_response import (
...
) -> Errors | TeststepresultAttachmentsSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = TeststepresultAttachmentsSingleGetResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | TeststepresultAttachmentsSingleGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | TeststepresultAttachmentsSingleGetResponse
    """
