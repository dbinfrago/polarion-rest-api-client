...
from ...models.workitem_comments_list_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/workitems/{work_item_id}/comments",
        "params": params,
    }
...
) -> Union[Errors, WorkitemCommentsListGetResponse] | None:
    if response.status_code == 200:
        response_200 = WorkitemCommentsListGetResponse.from_dict(
            response.json()
        )
