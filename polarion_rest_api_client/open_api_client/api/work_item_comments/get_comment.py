...
from ...models.workitem_comments_single_get_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/workitems/{work_item_id}/comments/{comment_id}".format(
...
) -> Errors | WorkitemCommentsSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = WorkitemCommentsSingleGetResponse.from_dict(
            response.json()
        )
