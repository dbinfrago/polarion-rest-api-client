...
from ...models.import_word_document_request_body import (
...
def _get_kwargs(
    ...
    space_id: str,
    *,
    body: ImportWordDocumentRequestBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/spaces/{space_id}/documents/actions/importWordDocument".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_id (str):
        space_id (str):
        body (ImportWordDocumentRequestBody): Request body for importing a Word document
