...
from ...models.workrecords_list_get_response import WorkrecordsListGetResponse
...
) -> Errors | WorkrecordsListGetResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | WorkrecordsListGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | WorkrecordsListGetResponse
    """
