...
from ...models.revisions_list_get_response import RevisionsListGetResponse
...
) -> Errors | RevisionsListGetResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | RevisionsListGetResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Errors | RevisionsListGetResponse
    """
