...
from ...models.page_attachments_list_get_response import (
...
) -> Errors | PageAttachmentsListGetResponse | None:
    if response.status_code == 200:
        response_200 = PageAttachmentsListGetResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | PageAttachmentsListGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | PageAttachmentsListGetResponse
    """
