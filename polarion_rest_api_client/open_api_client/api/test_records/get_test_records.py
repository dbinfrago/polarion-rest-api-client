...
from ...models.testrecords_list_get_response import TestrecordsListGetResponse
...
def _get_kwargs(
    ...
    *,
    ...
    test_case_project_id: str | Unset = UNSET,
    test_case_id: str | Unset = UNSET,
    test_result_id: str | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Errors | TestrecordsListGetResponse | None:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        include (str | Unset):
        revision (str | Unset):
        test_case_project_id (str | Unset):
        test_case_id (str | Unset):
        test_result_id (str | Unset):
