...
from ...models.testrecords_list_post_request import TestrecordsListPostRequest
from ...models.testrecords_list_post_response import (
...
def _get_kwargs(
    ...
    test_run_id: str,
    *,
    body: TestrecordsListPostRequest,
) -> dict[str, Any]:
...
) -> Union[Errors, TestrecordsListPostResponse] | None:
    if response.status_code == 201:
        response_201 = TestrecordsListPostResponse.from_dict(response.json())
