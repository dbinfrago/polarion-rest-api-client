...
from ...models.testrecords_single_get_response import (
...
) -> Union[Errors, TestrecordsSingleGetResponse] | None:
    if response.status_code == 200:
        response_200 = TestrecordsSingleGetResponse.from_dict(response.json())
