...
from ...models.generate_completion_request_body import (
    GenerateCompletionRequestBody,
)
from ...models.generate_completion_response_body import (
...
def _get_kwargs(
    *,
    body: GenerateCompletionRequestBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/llms/actions/generateCompletion",
    }
...
) -> Errors | GenerateCompletionResponseBody | None:
    if response.status_code == 200:
        response_200 = GenerateCompletionResponseBody.from_dict(
            response.json()
        )
