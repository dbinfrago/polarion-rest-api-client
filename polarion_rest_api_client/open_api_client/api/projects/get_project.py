...
from ...models.projects_single_get_response import ProjectsSingleGetResponse
...
) -> Errors | ProjectsSingleGetResponse | None:
    if response.status_code == 200:
        response_200 = ProjectsSingleGetResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Errors | ProjectsSingleGetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Errors | ProjectsSingleGetResponse
    """
