...
class WorkitemsSinglePatchRequestDataRelationshipsVotesDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsSinglePatchRequestDataRelationshipsVotesDataItemType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        WorkitemsSinglePatchRequestDataRelationshipsVotesDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_patch_request_data_relationships_votes_data_item_obj.additional_properties = d
