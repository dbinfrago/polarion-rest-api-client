...
class ProjectsSingleGetResponseDataAttributesDescription:
    """
    Attributes:
        type_ (ProjectsSingleGetResponseDataAttributesDescriptionType | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ProjectsSingleGetResponseDataAttributesDescriptionType(
                _type_
            )
        ...
        projects_single_get_response_data_attributes_description_obj.additional_properties = d
