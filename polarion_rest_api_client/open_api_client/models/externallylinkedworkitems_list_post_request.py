...
T = TypeVar("T", bound="ExternallylinkedworkitemsListPostRequest")
...
class ExternallylinkedworkitemsListPostRequest:
    """
    Attributes:
        data (list[ExternallylinkedworkitemsListPostRequestDataItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: (
            list[ExternallylinkedworkitemsListPostRequestDataItem] | Unset
        ) = UNSET
        if _data is not UNSET:
            data = []
            for data_item_data in _data:
                data_item = (
                    ExternallylinkedworkitemsListPostRequestDataItem.from_dict(
                        data_item_data
                    )
                )
        ...
        externallylinkedworkitems_list_post_request_obj = cls(
            data=data,
        )
