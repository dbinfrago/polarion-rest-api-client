...
class WorkitemApprovalsListDeleteRequestDataItem:
    """
    Attributes:
        type_ (WorkitemApprovalsListDeleteRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyUserId.
    """

    type_: WorkitemApprovalsListDeleteRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemApprovalsListDeleteRequestDataItemType(_type_)
        ...
        workitem_approvals_list_delete_request_data_item_obj.additional_properties = d
