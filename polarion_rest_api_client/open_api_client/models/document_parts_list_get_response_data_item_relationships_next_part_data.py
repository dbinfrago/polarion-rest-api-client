...
class DocumentPartsListGetResponseDataItemRelationshipsNextPartData:
    ...
    Attributes:
        ...
        type_ (DocumentPartsListGetResponseDataItemRelationshipsNextPartDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_parts_list_get_response_data_item_relationships_next_part_data_obj = cls(
            id=id,
            revision=revision,
            type_=type_,
        )

        document_parts_list_get_response_data_item_relationships_next_part_data_obj.additional_properties = d
        return document_parts_list_get_response_data_item_relationships_next_part_data_obj
