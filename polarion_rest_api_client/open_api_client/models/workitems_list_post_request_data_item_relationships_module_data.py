...
class WorkitemsListPostRequestDataItemRelationshipsModuleData:
    ...
    Attributes:
        ...
        type_ (WorkitemsListPostRequestDataItemRelationshipsModuleDataType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        WorkitemsListPostRequestDataItemRelationshipsModuleDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_post_request_data_item_relationships_module_data_obj.additional_properties = d
        return (
            workitems_list_post_request_data_item_relationships_module_data_obj
        )
