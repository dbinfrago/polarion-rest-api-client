...
class TestrecordsListPostResponseDataItem:
    """
    Attributes:
        type_ (TestrecordsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: elibrary/MyTestRunId/MyProjectId/MyTestcaseId/0.
        links (TestrecordsListPostResponseDataItemLinks | Unset):
    """

    type_: TestrecordsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: TestrecordsListPostResponseDataItemLinks | Unset = UNSET
