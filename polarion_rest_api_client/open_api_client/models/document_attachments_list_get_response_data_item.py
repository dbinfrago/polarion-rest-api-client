...
class DocumentAttachmentsListGetResponseDataItem:
    """
    Attributes:
        type_ (DocumentAttachmentsListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MySpaceId/MyDocumentId/MyAttachmentId.
        revision (str | Unset):  Example: 1234.
        attributes (DocumentAttachmentsListGetResponseDataItemAttributes | Unset):
        relationships (DocumentAttachmentsListGetResponseDataItemRelationships | Unset):
        links (DocumentAttachmentsListGetResponseDataItemLinks | Unset):
        meta (DocumentAttachmentsListGetResponseDataItemMeta | Unset):
    """

    type_: DocumentAttachmentsListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: (
        DocumentAttachmentsListGetResponseDataItemAttributes | Unset
    ) = UNSET
    relationships: (
        DocumentAttachmentsListGetResponseDataItemRelationships | Unset
    ) = UNSET
    links: DocumentAttachmentsListGetResponseDataItemLinks | Unset = UNSET
    meta: DocumentAttachmentsListGetResponseDataItemMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_attachments_list_get_response_data_item_obj.additional_properties = d
