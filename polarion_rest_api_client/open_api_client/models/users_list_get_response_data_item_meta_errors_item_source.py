...
T = TypeVar("T", bound="UsersListGetResponseDataItemMetaErrorsItemSource")
...
class UsersListGetResponseDataItemMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (UsersListGetResponseDataItemMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        UsersListGetResponseDataItemMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = UsersListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                _resource
            )

        users_list_get_response_data_item_meta_errors_item_source_obj = cls(
            parameter=parameter,
            pointer=pointer,
            resource=resource,
        )
