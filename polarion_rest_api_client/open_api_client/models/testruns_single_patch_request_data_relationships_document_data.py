...
class TestrunsSinglePatchRequestDataRelationshipsDocumentData:
    ...
    Attributes:
        ...
        type_ (TestrunsSinglePatchRequestDataRelationshipsDocumentDataType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        TestrunsSinglePatchRequestDataRelationshipsDocumentDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_patch_request_data_relationships_document_data_obj.additional_properties = d
        return (
            testruns_single_patch_request_data_relationships_document_data_obj
        )
