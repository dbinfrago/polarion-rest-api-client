...
class DocumentCommentsListGetResponseDataItemRelationshipsProject:
    """
    Attributes:
        data (DocumentCommentsListGetResponseDataItemRelationshipsProjectData | Unset):
    """

    data: (
        DocumentCommentsListGetResponseDataItemRelationshipsProjectData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_comments_list_get_response_data_item_relationships_project_obj.additional_properties = d
