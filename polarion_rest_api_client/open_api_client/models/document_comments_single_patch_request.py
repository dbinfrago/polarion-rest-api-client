...
if TYPE_CHECKING:
    from ..models.document_comments_single_patch_request_data import (
        DocumentCommentsSinglePatchRequestData,
    )


T = TypeVar("T", bound="DocumentCommentsSinglePatchRequest")
...
class DocumentCommentsSinglePatchRequest:
    """
    Attributes:
        data (DocumentCommentsSinglePatchRequestData | Unset):
    """

    data: DocumentCommentsSinglePatchRequestData | Unset = UNSET
