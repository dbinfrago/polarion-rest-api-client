...
if TYPE_CHECKING:
    from ..models.document_attachments_single_get_response_data_meta_errors_item_source_resource import (
        DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource,
    )


T = TypeVar(
    "T", bound="DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSource"
)


@_attrs_define
class DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the
            error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        document_attachments_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
