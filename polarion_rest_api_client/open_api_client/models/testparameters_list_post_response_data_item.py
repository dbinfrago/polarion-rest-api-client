...
class TestparametersListPostResponseDataItem:
    """
    Attributes:
        type_ (TestparametersListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyTestParameter.
        links (TestparametersListPostResponseDataItemLinks | Unset):
    """

    type_: TestparametersListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: TestparametersListPostResponseDataItemLinks | Unset = UNSET
