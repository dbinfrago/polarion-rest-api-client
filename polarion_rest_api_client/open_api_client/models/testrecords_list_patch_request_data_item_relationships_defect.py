...
T = TypeVar(
    "T", bound="TestrecordsListPatchRequestDataItemRelationshipsDefect"
)
...
class TestrecordsListPatchRequestDataItemRelationshipsDefect:
    """
    Attributes:
        data (TestrecordsListPatchRequestDataItemRelationshipsDefectData | Unset):
    """

    data: (
        TestrecordsListPatchRequestDataItemRelationshipsDefectData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TestrecordsListPatchRequestDataItemRelationshipsDefectData.from_dict(
                _data
            )
