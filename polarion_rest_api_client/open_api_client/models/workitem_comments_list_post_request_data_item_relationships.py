...
class WorkitemCommentsListPostRequestDataItemRelationships:
    """
    Attributes:
        author (WorkitemCommentsListPostRequestDataItemRelationshipsAuthor | Unset):
        parent_comment (WorkitemCommentsListPostRequestDataItemRelationshipsParentComment | Unset):
    """

    author: (
        WorkitemCommentsListPostRequestDataItemRelationshipsAuthor | Unset
    ) = UNSET
    parent_comment: (
        WorkitemCommentsListPostRequestDataItemRelationshipsParentComment
        | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_list_post_request_data_item_relationships_obj.additional_properties = d
