...
class ExternallylinkedworkitemsListPostResponseDataItem:
    """
    Attributes:
        type_ (ExternallylinkedworkitemsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/parent/hostname/MyProjectId/MyLinkedWorkItemId.
        links (ExternallylinkedworkitemsListPostResponseDataItemLinks | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_list_post_response_data_item_obj.additional_properties = d
