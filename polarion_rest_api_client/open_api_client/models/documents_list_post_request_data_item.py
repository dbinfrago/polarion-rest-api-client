...
class DocumentsListPostRequestDataItem:
    """
    Attributes:
        type_ (DocumentsListPostRequestDataItemType | Unset):
        attributes (DocumentsListPostRequestDataItemAttributes | Unset):
    """

    type_: DocumentsListPostRequestDataItemType | Unset = UNSET
    attributes: DocumentsListPostRequestDataItemAttributes | Unset = UNSET
