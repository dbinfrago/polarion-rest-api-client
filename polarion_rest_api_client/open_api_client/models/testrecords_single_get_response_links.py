...
T = TypeVar("T", bound="TestrecordsSingleGetResponseLinks")
...
class TestrecordsSingleGetResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_single_get_response_links_obj = cls(
            self_=self_,
        )

        testrecords_single_get_response_links_obj.additional_properties = d
