...
class DocumentAttachmentsSingleGetResponse:
    """
    Attributes:
        data (DocumentAttachmentsSingleGetResponseData | Unset):
        included (list[DocumentAttachmentsSingleGetResponseIncludedItem] | Unset): Related entities might be returned,
            ...
            Guide</a>.
        links (DocumentAttachmentsSingleGetResponseLinks | Unset):
    """

    data: DocumentAttachmentsSingleGetResponseData | Unset = UNSET
    included: (
        list[DocumentAttachmentsSingleGetResponseIncludedItem] | Unset
    ) = UNSET
    links: DocumentAttachmentsSingleGetResponseLinks | Unset = UNSET
