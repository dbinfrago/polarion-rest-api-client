...
from ..models.plans_single_get_response_data_attributes_calculation_type import (
    PlansSingleGetResponseDataAttributesCalculationType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.plans_single_get_response_data_attributes_description import (
        PlansSingleGetResponseDataAttributesDescription,
    )
    from ..models.plans_single_get_response_data_attributes_home_page_content import (
        PlansSingleGetResponseDataAttributesHomePageContent,
    )


T = TypeVar("T", bound="PlansSingleGetResponseDataAttributes")
...
class PlansSingleGetResponseDataAttributes:
    ...
    Attributes:
        ...
        calculation_type (PlansSingleGetResponseDataAttributesCalculationType | Unset):  Example: timeBased.
        ...
        description (PlansSingleGetResponseDataAttributesDescription | Unset):
        ...
        home_page_content (PlansSingleGetResponseDataAttributesHomePageContent | Unset):
    ...
    calculation_type: (
        PlansSingleGetResponseDataAttributesCalculationType | Unset
    ) = UNSET
    ...
    home_page_content: (
        PlansSingleGetResponseDataAttributesHomePageContent | Unset
    ) = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                PlansSingleGetResponseDataAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                PlansSingleGetResponseDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        plans_single_get_response_data_attributes_obj = cls(
        ...
        plans_single_get_response_data_attributes_obj.additional_properties = d
        return plans_single_get_response_data_attributes_obj
