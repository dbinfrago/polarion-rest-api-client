...
class WorkitemCommentsSingleGetResponseDataAttributes:
    ...
    Attributes:
        ...
        resolved (bool | Unset):
        text (WorkitemCommentsSingleGetResponseDataAttributesText | Unset):
    ...
    text: WorkitemCommentsSingleGetResponseDataAttributesText | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_single_get_response_data_attributes_obj.additional_properties = d
