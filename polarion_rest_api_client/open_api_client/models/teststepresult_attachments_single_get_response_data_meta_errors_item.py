...
if TYPE_CHECKING:
    from ..models.teststepresult_attachments_single_get_response_data_meta_errors_item_source import (
        TeststepresultAttachmentsSingleGetResponseDataMetaErrorsItemSource,
    )


T = TypeVar(
    "T", bound="TeststepresultAttachmentsSingleGetResponseDataMetaErrorsItem"
)
...
class TeststepresultAttachmentsSingleGetResponseDataMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = TeststepresultAttachmentsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        teststepresult_attachments_single_get_response_data_meta_errors_item_obj = cls(
            detail=detail,
            source=source,
            status=status,
            title=title,
        ...
        teststepresult_attachments_single_get_response_data_meta_errors_item_obj.additional_properties = d
