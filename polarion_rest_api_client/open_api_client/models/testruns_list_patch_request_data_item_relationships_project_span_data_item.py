...
class TestrunsListPatchRequestDataItemRelationshipsProjectSpanDataItem:
    ...
    Attributes:
        ...
        type_ (TestrunsListPatchRequestDataItemRelationshipsProjectSpanDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunsListPatchRequestDataItemRelationshipsProjectSpanDataItemType(
                _type_
            )
        ...
        testruns_list_patch_request_data_item_relationships_project_span_data_item_obj.additional_properties = d
