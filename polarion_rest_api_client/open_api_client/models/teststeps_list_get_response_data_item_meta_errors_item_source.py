...
class TeststepsListGetResponseDataItemMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (TeststepsListGetResponseDataItemMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        TeststepsListGetResponseDataItemMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_list_get_response_data_item_meta_errors_item_source_obj.additional_properties = d
        return (
            teststeps_list_get_response_data_item_meta_errors_item_source_obj
        )
