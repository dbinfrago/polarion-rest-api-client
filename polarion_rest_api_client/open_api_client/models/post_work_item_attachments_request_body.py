...
if TYPE_CHECKING:
    from ..models.workitem_attachments_list_post_request import (
...
class PostWorkItemAttachmentsRequestBody:
    ...
    Attributes:
        ...
        resource (WorkitemAttachmentsListPostRequest | Unset):
    """

    files: list[File] | Unset = UNSET
    resource: WorkitemAttachmentsListPostRequest | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return post_work_item_attachments_request_body_obj
