...
T = TypeVar("T", bound="WorkrecordsSingleGetResponseLinks")
...
class WorkrecordsSingleGetResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_single_get_response_links_obj = cls(
            self_=self_,
        )

        workrecords_single_get_response_links_obj.additional_properties = d
