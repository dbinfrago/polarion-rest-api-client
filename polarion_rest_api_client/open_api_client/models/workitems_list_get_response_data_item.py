...
class WorkitemsListGetResponseDataItem:
    """
    Attributes:
        type_ (WorkitemsListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId.
        revision (str | Unset):  Example: 1234.
        attributes (WorkitemsListGetResponseDataItemAttributes | Unset):
        relationships (WorkitemsListGetResponseDataItemRelationships | Unset):
        links (WorkitemsListGetResponseDataItemLinks | Unset):
        meta (WorkitemsListGetResponseDataItemMeta | Unset):
    """

    type_: WorkitemsListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: WorkitemsListGetResponseDataItemAttributes | Unset = UNSET
    relationships: WorkitemsListGetResponseDataItemRelationships | Unset = (
        UNSET
    )
    links: WorkitemsListGetResponseDataItemLinks | Unset = UNSET
    meta: WorkitemsListGetResponseDataItemMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListGetResponseDataItemType(_type_)
