...
class TestparametersSingleGetResponseData:
    """
    Attributes:
        type_ (TestparametersSingleGetResponseDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyTestParameter.
        revision (str | Unset):  Example: 1234.
        attributes (TestparametersSingleGetResponseDataAttributes | Unset):
        relationships (TestparametersSingleGetResponseDataRelationships | Unset):
        links (TestparametersSingleGetResponseDataLinks | Unset):
        meta (TestparametersSingleGetResponseDataMeta | Unset):
    """

    type_: TestparametersSingleGetResponseDataType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: TestparametersSingleGetResponseDataAttributes | Unset = UNSET
    relationships: TestparametersSingleGetResponseDataRelationships | Unset = (
        UNSET
    )
    links: TestparametersSingleGetResponseDataLinks | Unset = UNSET
    meta: TestparametersSingleGetResponseDataMeta | Unset = UNSET
