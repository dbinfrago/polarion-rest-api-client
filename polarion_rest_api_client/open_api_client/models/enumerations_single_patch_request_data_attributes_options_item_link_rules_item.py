...
T = TypeVar(
    "T",
    bound="EnumerationsSinglePatchRequestDataAttributesOptionsItemLinkRulesItem",
)


@_attrs_define
class EnumerationsSinglePatchRequestDataAttributesOptionsItemLinkRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_single_patch_request_data_attributes_options_item_link_rules_item_obj = cls(
            from_types=from_types,
            same_type=same_type,
            to_types=to_types,
        )

        enumerations_single_patch_request_data_attributes_options_item_link_rules_item_obj.additional_properties = d
        return enumerations_single_patch_request_data_attributes_options_item_link_rules_item_obj
