...
class UsersSinglePatchRequestDataRelationshipsUserGroupsDataItem:
    ...
    Attributes:
        ...
        type_ (UsersSinglePatchRequestDataRelationshipsUserGroupsDataItemType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        UsersSinglePatchRequestDataRelationshipsUserGroupsDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_single_patch_request_data_relationships_user_groups_data_item_obj.additional_properties = d
