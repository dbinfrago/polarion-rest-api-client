...
class TestrunAttachmentsListGetResponseDataItem:
    """
    Attributes:
        type_ (TestrunAttachmentsListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyAttachmentId.
        revision (str | Unset):  Example: 1234.
        attributes (TestrunAttachmentsListGetResponseDataItemAttributes | Unset):
        relationships (TestrunAttachmentsListGetResponseDataItemRelationships | Unset):
        links (TestrunAttachmentsListGetResponseDataItemLinks | Unset):
        meta (TestrunAttachmentsListGetResponseDataItemMeta | Unset):
    """

    type_: TestrunAttachmentsListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    relationships: (
        TestrunAttachmentsListGetResponseDataItemRelationships | Unset
    ) = UNSET
    links: TestrunAttachmentsListGetResponseDataItemLinks | Unset = UNSET
    meta: TestrunAttachmentsListGetResponseDataItemMeta | Unset = UNSET
