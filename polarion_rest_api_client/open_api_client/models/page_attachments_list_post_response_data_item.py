...
class PageAttachmentsListPostResponseDataItem:
    """
    Attributes:
        type_ (PageAttachmentsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MySpaceId/MyRichPageId/MyAttachmentId.
        links (PageAttachmentsListPostResponseDataItemLinks | Unset):
    """

    type_: PageAttachmentsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: PageAttachmentsListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PageAttachmentsListPostResponseDataItemType(_type_)
        ...
        page_attachments_list_post_response_data_item_obj.additional_properties = d
