...
if TYPE_CHECKING:
    from ..models.license_single_patch_request_data_relationships_default_add_on_license_slots import (
        LicenseSinglePatchRequestDataRelationshipsDefaultAddOnLicenseSlots,
    )
    from ..models.license_single_patch_request_data_relationships_default_base_license_slot import (
        LicenseSinglePatchRequestDataRelationshipsDefaultBaseLicenseSlot,
    )


T = TypeVar("T", bound="LicenseSinglePatchRequestDataRelationships")


@_attrs_define
class LicenseSinglePatchRequestDataRelationships:
    """
    Attributes:
        default_add_on_license_slots (LicenseSinglePatchRequestDataRelationshipsDefaultAddOnLicenseSlots | Unset):
        default_base_license_slot (LicenseSinglePatchRequestDataRelationshipsDefaultBaseLicenseSlot | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_add_on_license_slots, Unset):
            ...
            default_add_on_license_slots = LicenseSinglePatchRequestDataRelationshipsDefaultAddOnLicenseSlots.from_dict(
        ...
        if isinstance(_default_base_license_slot, Unset):
            ...
            default_base_license_slot = LicenseSinglePatchRequestDataRelationshipsDefaultBaseLicenseSlot.from_dict(
                _default_base_license_slot
            )

        license_single_patch_request_data_relationships_obj = cls(
            default_add_on_license_slots=default_add_on_license_slots,
            default_base_license_slot=default_base_license_slot,
        )

        license_single_patch_request_data_relationships_obj.additional_properties = d
        return license_single_patch_request_data_relationships_obj
