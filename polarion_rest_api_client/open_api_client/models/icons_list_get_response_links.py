...
T = TypeVar("T", bound="IconsListGetResponseLinks")
...
class IconsListGetResponseLinks:
    ...
    Attributes:
        ...
        next_ (str | Unset):  Example: server-host-name/application-
            path/enumerations/defaulticons?page%5Bsize%5D=10&page%5Bnumber%5D=6.
        prev (str | Unset):  Example: server-host-name/application-
            path/enumerations/defaulticons?page%5Bsize%5D=10&page%5Bnumber%5D=4.
        self_ (str | Unset):  Example: server-host-name/application-
            path/enumerations/defaulticons?page%5Bsize%5D=10&page%5Bnumber%5D=5.
    """
