...
T = TypeVar(
    "T",
    bound="WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsLinks",
)


@_attrs_define
class WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsLinks:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_linked_work_items_links_obj.additional_properties = d
