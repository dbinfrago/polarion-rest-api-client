...
class DocumentCommentsListPostRequestDataItemRelationshipsAuthor:
    """
    Attributes:
        data (DocumentCommentsListPostRequestDataItemRelationshipsAuthorData | Unset):
    """

    data: (
        DocumentCommentsListPostRequestDataItemRelationshipsAuthorData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_comments_list_post_request_data_item_relationships_author_obj.additional_properties = d
