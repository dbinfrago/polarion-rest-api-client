...
class PlansListPostRequestDataItemRelationshipsParentData:
    ...
    Attributes:
        ...
        type_ (PlansListPostRequestDataItemRelationshipsParentDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListPostRequestDataItemRelationshipsParentDataType(
                _type_
            )
        ...
        plans_list_post_request_data_item_relationships_parent_data_obj.additional_properties = d
