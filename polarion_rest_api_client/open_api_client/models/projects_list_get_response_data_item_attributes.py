...
class ProjectsListGetResponseDataItemAttributes:
    ...
    Attributes:
        ...
        description (ProjectsListGetResponseDataItemAttributesDescription | Unset):
    ...
    description: (
        ProjectsListGetResponseDataItemAttributesDescription | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                ProjectsListGetResponseDataItemAttributesDescription.from_dict(
                    _description
                )
            )
