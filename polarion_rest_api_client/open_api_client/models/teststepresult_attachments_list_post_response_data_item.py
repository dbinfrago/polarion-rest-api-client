...
class TeststepresultAttachmentsListPostResponseDataItem:
    """
    Attributes:
        type_ (TeststepresultAttachmentsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyProjectId/MyTestcaseId/0/1/MyAttachmentId.
        links (TeststepresultAttachmentsListPostResponseDataItemLinks | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_list_post_response_data_item_obj.additional_properties = d
