...
class LinkedworkitemsListDeleteRequestDataItem:
    """
    Attributes:
        type_ (LinkedworkitemsListDeleteRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/parent/MyProjectId/MyLinkedWorkItemId.
    """

    type_: LinkedworkitemsListDeleteRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = LinkedworkitemsListDeleteRequestDataItemType(_type_)
        ...
        linkedworkitems_list_delete_request_data_item_obj.additional_properties = d
