...
if TYPE_CHECKING:
    from ..models.pages_single_get_response_data_meta_errors_item_source_resource import (
        PagesSingleGetResponseDataMetaErrorsItemSourceResource,
    )


T = TypeVar("T", bound="PagesSingleGetResponseDataMetaErrorsItemSource")


@_attrs_define
class PagesSingleGetResponseDataMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (PagesSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        PagesSingleGetResponseDataMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = PagesSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        pages_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
