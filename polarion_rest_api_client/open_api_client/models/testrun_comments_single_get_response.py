...
class TestrunCommentsSingleGetResponse:
    """
    Attributes:
        data (TestrunCommentsSingleGetResponseData | Unset):
        included (list[TestrunCommentsSingleGetResponseIncludedItem] | Unset): Related entities might be returned, see
            ...
            Guide</a>.
        links (TestrunCommentsSingleGetResponseLinks | Unset):
    """

    data: TestrunCommentsSingleGetResponseData | Unset = UNSET
    included: list[TestrunCommentsSingleGetResponseIncludedItem] | Unset = (
        UNSET
    )
    links: TestrunCommentsSingleGetResponseLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        included: (
            list[TestrunCommentsSingleGetResponseIncludedItem] | Unset
        ) = UNSET
