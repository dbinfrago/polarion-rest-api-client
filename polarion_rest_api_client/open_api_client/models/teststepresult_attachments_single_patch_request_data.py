...
class TeststepresultAttachmentsSinglePatchRequestData:
    """
    Attributes:
        type_ (TeststepresultAttachmentsSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyProjectId/MyTestcaseId/0/1/MyAttachmentId.
        attributes (TeststepresultAttachmentsSinglePatchRequestDataAttributes | Unset):
    """

    type_: TeststepresultAttachmentsSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: (
        TeststepresultAttachmentsSinglePatchRequestDataAttributes | Unset
    ) = UNSET
