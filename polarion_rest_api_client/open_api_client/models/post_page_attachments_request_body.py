...
if TYPE_CHECKING:
    from ..models.page_attachments_list_post_request import (
        PageAttachmentsListPostRequest,
    )


T = TypeVar("T", bound="PostPageAttachmentsRequestBody")


@_attrs_define
class PostPageAttachmentsRequestBody:
    """
    Attributes:
        files (list[File] | Unset):
        resource (PageAttachmentsListPostRequest | Unset):
    """

    files: list[File] | Unset = UNSET
    resource: PageAttachmentsListPostRequest | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = PageAttachmentsListPostRequest.from_dict(_resource)
