...
if TYPE_CHECKING:
    from ..models.document_parts_list_post_request_data_item_relationships_next_part_data import (
        DocumentPartsListPostRequestDataItemRelationshipsNextPartData,
    )


T = TypeVar(
    "T", bound="DocumentPartsListPostRequestDataItemRelationshipsNextPart"
)
...
class DocumentPartsListPostRequestDataItemRelationshipsNextPart:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DocumentPartsListPostRequestDataItemRelationshipsNextPartData.from_dict(
                _data
            )
        ...
        document_parts_list_post_request_data_item_relationships_next_part_obj.additional_properties = d
