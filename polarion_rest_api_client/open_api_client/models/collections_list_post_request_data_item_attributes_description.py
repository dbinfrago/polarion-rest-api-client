...
class CollectionsListPostRequestDataItemAttributesDescription:
    """
    Attributes:
        type_ (CollectionsListPostRequestDataItemAttributesDescriptionType | Unset):
        value (str | Unset):  Example: My text value.
    """

    type_: (
        CollectionsListPostRequestDataItemAttributesDescriptionType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_post_request_data_item_attributes_description_obj.additional_properties = d
        return (
            collections_list_post_request_data_item_attributes_description_obj
        )
