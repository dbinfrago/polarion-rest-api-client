...
T = TypeVar("T", bound="WorkitemAttachmentsSinglePatchRequestDataAttributes")
...
class WorkitemAttachmentsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_single_patch_request_data_attributes_obj.additional_properties = d
