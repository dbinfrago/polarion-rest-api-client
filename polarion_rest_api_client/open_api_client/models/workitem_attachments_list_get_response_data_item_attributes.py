...
T = TypeVar("T", bound="WorkitemAttachmentsListGetResponseDataItemAttributes")
...
class WorkitemAttachmentsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_list_get_response_data_item_attributes_obj.additional_properties = d
        return workitem_attachments_list_get_response_data_item_attributes_obj
