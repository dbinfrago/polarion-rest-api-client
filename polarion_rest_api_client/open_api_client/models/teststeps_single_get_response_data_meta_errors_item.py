...
if TYPE_CHECKING:
    from ..models.teststeps_single_get_response_data_meta_errors_item_source import (
...
@_attrs_define
class TeststepsSingleGetResponseDataMetaErrorsItem:
    """
    Attributes:
        ...
        source (TeststepsSingleGetResponseDataMetaErrorsItemSource | Unset):
    ...
    source: TeststepsSingleGetResponseDataMetaErrorsItemSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                TeststepsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                    _source
                )
            )
        ...
        teststeps_single_get_response_data_meta_errors_item_obj = cls(
            detail=detail,
            source=source,
            status=status,
            title=title,
        ...
        teststeps_single_get_response_data_meta_errors_item_obj.additional_properties = d
