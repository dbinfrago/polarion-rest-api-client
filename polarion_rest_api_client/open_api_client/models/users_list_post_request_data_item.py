...
class UsersListPostRequestDataItem:
    """
    Attributes:
        type_ (UsersListPostRequestDataItemType | Unset):
        attributes (UsersListPostRequestDataItemAttributes | Unset):
        relationships (UsersListPostRequestDataItemRelationships | Unset):
    """

    type_: UsersListPostRequestDataItemType | Unset = UNSET
    attributes: UsersListPostRequestDataItemAttributes | Unset = UNSET
    relationships: UsersListPostRequestDataItemRelationships | Unset = UNSET
