...
if TYPE_CHECKING:
    from ..models.globalroles_single_get_response_data_meta_errors_item_source_resource import (
...
@_attrs_define
class GlobalrolesSingleGetResponseDataMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (GlobalrolesSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        GlobalrolesSingleGetResponseDataMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = GlobalrolesSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        globalroles_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
