...
if TYPE_CHECKING:
    ...
    from ..models.users_list_get_response_data_item_relationships_project_roles import (
        UsersListGetResponseDataItemRelationshipsProjectRoles,
    )
    from ..models.users_list_get_response_data_item_relationships_user_groups import (
...
class UsersListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_global_roles, Unset):
            ...
            global_roles = (
                UsersListGetResponseDataItemRelationshipsGlobalRoles.from_dict(
                    _global_roles
                )
            )
        ...
        if isinstance(_project_roles, Unset):
            ...
            project_roles = UsersListGetResponseDataItemRelationshipsProjectRoles.from_dict(
                _project_roles
            )
        ...
        if isinstance(_user_groups, Unset):
            ...
            user_groups = (
                UsersListGetResponseDataItemRelationshipsUserGroups.from_dict(
                    _user_groups
                )
            )
