...
class TestparameterDefinitionsListGetResponse:
    """
    Attributes:
        data (list[TestparameterDefinitionsListGetResponseDataItem] | Unset):
        included (list[TestparameterDefinitionsListGetResponseIncludedItem] | Unset): Related entities might be
            ...
            Guide</a>.
        links (TestparameterDefinitionsListGetResponseLinks | Unset):
        meta (TestparameterDefinitionsListGetResponseMeta | Unset):
    """

    data: list[TestparameterDefinitionsListGetResponseDataItem] | Unset = UNSET
    included: (
        list[TestparameterDefinitionsListGetResponseIncludedItem] | Unset
    ) = UNSET
    links: TestparameterDefinitionsListGetResponseLinks | Unset = UNSET
    meta: TestparameterDefinitionsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _included is not UNSET:
            ...
            for included_item_data in _included:
                included_item = TestparameterDefinitionsListGetResponseIncludedItem.from_dict(
                    included_item_data
                )
