...
class RevisionsListGetResponseDataItemMeta:
    """
    Attributes:
        errors (list[RevisionsListGetResponseDataItemMetaErrorsItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        errors: (
            list[RevisionsListGetResponseDataItemMetaErrorsItem] | Unset
        ) = UNSET
        ...
        revisions_list_get_response_data_item_meta_obj.additional_properties = d
