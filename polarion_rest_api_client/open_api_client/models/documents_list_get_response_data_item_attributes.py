...
if TYPE_CHECKING:
    from ..models.documents_list_get_response_data_item_attributes_home_page_content import (
        DocumentsListGetResponseDataItemAttributesHomePageContent,
    )
    from ..models.documents_list_get_response_data_item_attributes_outline_numbering import (
        DocumentsListGetResponseDataItemAttributesOutlineNumbering,
    )
    from ..models.documents_list_get_response_data_item_attributes_rendering_layouts_item import (
        DocumentsListGetResponseDataItemAttributesRenderingLayoutsItem,
    )


T = TypeVar("T", bound="DocumentsListGetResponseDataItemAttributes")


@_attrs_define
class DocumentsListGetResponseDataItemAttributes:
    """
    Attributes:
        ...
        home_page_content (DocumentsListGetResponseDataItemAttributesHomePageContent | Unset):
        module_folder (str | Unset):  Example: MySpaceId.
        module_name (str | Unset):  Example: MyDocumentId.
        outline_numbering (DocumentsListGetResponseDataItemAttributesOutlineNumbering | Unset):
        rendering_layouts (list[DocumentsListGetResponseDataItemAttributesRenderingLayoutsItem] | Unset):
    ...
    home_page_content: (
        DocumentsListGetResponseDataItemAttributesHomePageContent | Unset
    ) = UNSET
    module_folder: str | Unset = UNSET
    module_name: str | Unset = UNSET
    outline_numbering: (
        DocumentsListGetResponseDataItemAttributesOutlineNumbering | Unset
    ) = UNSET
    rendering_layouts: (
        list[DocumentsListGetResponseDataItemAttributesRenderingLayoutsItem]
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = DocumentsListGetResponseDataItemAttributesHomePageContent.from_dict(
                _home_page_content
            )
        ...
        if isinstance(_outline_numbering, Unset):
            ...
            outline_numbering = DocumentsListGetResponseDataItemAttributesOutlineNumbering.from_dict(
                _outline_numbering
            )
        ...
        if _rendering_layouts is not UNSET:
            ...
            for rendering_layouts_item_data in _rendering_layouts:
                rendering_layouts_item = DocumentsListGetResponseDataItemAttributesRenderingLayoutsItem.from_dict(
        ...
        documents_list_get_response_data_item_attributes_obj = cls(
        ...
        documents_list_get_response_data_item_attributes_obj.additional_properties = d
        return documents_list_get_response_data_item_attributes_obj
