...
T = TypeVar("T", bound="TestrecordsSingleGetResponseDataAttributes")
...
class TestrecordsSingleGetResponseDataAttributes:
    """
    Attributes:
        comment (TestrecordsSingleGetResponseDataAttributesComment | Unset):
    ...
    comment: TestrecordsSingleGetResponseDataAttributesComment | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = (
                TestrecordsSingleGetResponseDataAttributesComment.from_dict(
                    _comment
                )
            )
        ...
        testrecords_single_get_response_data_attributes_obj = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            iteration=iteration,
