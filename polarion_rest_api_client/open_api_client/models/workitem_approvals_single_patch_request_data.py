...
class WorkitemApprovalsSinglePatchRequestData:
    """
    Attributes:
        type_ (WorkitemApprovalsSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyUserId.
        attributes (WorkitemApprovalsSinglePatchRequestDataAttributes | Unset):
    """

    type_: WorkitemApprovalsSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: WorkitemApprovalsSinglePatchRequestDataAttributes | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemApprovalsSinglePatchRequestDataType(_type_)
        ...
        workitem_approvals_single_patch_request_data_obj.additional_properties = d
