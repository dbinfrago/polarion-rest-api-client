...
class LinkedworkitemsListPostRequestDataItemRelationshipsWorkItem:
    """
    Attributes:
        data (LinkedworkitemsListPostRequestDataItemRelationshipsWorkItemData | Unset):
    """

    data: (
        LinkedworkitemsListPostRequestDataItemRelationshipsWorkItemData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linkedworkitems_list_post_request_data_item_relationships_work_item_obj.additional_properties = d
