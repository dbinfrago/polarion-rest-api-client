...
if TYPE_CHECKING:
    from ..models.testrecords_single_get_response_data import (
        TestrecordsSingleGetResponseData,
    )
    from ..models.testrecords_single_get_response_included_item import (
        TestrecordsSingleGetResponseIncludedItem,
    )
    from ..models.testrecords_single_get_response_links import (
        TestrecordsSingleGetResponseLinks,
    )


T = TypeVar("T", bound="TestrecordsSingleGetResponse")
...
class TestrecordsSingleGetResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = TestrecordsSingleGetResponseLinks.from_dict(_links)

        testrecords_single_get_response_obj = cls(
            data=data,
            included=included,
            links=links,
        )

        testrecords_single_get_response_obj.additional_properties = d
        return testrecords_single_get_response_obj
