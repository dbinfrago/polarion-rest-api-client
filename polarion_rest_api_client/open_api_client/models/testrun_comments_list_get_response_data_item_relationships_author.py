...
class TestrunCommentsListGetResponseDataItemRelationshipsAuthor:
    """
    Attributes:
        data (TestrunCommentsListGetResponseDataItemRelationshipsAuthorData | Unset):
    """

    data: (
        TestrunCommentsListGetResponseDataItemRelationshipsAuthorData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_comments_list_get_response_data_item_relationships_author_obj.additional_properties = d
