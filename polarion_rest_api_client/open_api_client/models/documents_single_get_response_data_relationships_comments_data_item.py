...
class DocumentsSingleGetResponseDataRelationshipsCommentsDataItem:
    ...
    Attributes:
        ...
        type_ (DocumentsSingleGetResponseDataRelationshipsCommentsDataItemType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        DocumentsSingleGetResponseDataRelationshipsCommentsDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentsSingleGetResponseDataRelationshipsCommentsDataItemType(
                _type_
            )
        ...
        documents_single_get_response_data_relationships_comments_data_item_obj.additional_properties = d
