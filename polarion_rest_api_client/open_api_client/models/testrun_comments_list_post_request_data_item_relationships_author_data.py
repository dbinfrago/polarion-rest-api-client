...
class TestrunCommentsListPostRequestDataItemRelationshipsAuthorData:
    ...
    Attributes:
        ...
        type_ (TestrunCommentsListPostRequestDataItemRelationshipsAuthorDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunCommentsListPostRequestDataItemRelationshipsAuthorDataType(
                _type_
            )
        ...
        testrun_comments_list_post_request_data_item_relationships_author_data_obj.additional_properties = d
