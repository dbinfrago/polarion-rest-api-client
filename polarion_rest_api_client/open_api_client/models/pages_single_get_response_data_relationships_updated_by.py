...
class PagesSingleGetResponseDataRelationshipsUpdatedBy:
    """
    Attributes:
        data (PagesSingleGetResponseDataRelationshipsUpdatedByData | Unset):
    """

    data: PagesSingleGetResponseDataRelationshipsUpdatedByData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pages_single_get_response_data_relationships_updated_by_obj.additional_properties = d
