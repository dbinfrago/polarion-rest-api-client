...
class WorkrecordsSingleGetResponseDataMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (WorkrecordsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        WorkrecordsSingleGetResponseDataMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
