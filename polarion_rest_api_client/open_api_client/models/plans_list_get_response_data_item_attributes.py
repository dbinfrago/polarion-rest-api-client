...
class PlansListGetResponseDataItemAttributes:
    ...
    Attributes:
        ...
        calculation_type (PlansListGetResponseDataItemAttributesCalculationType | Unset):  Example: timeBased.
        ...
        description (PlansListGetResponseDataItemAttributesDescription | Unset):
        ...
        home_page_content (PlansListGetResponseDataItemAttributesHomePageContent | Unset):
    ...
    calculation_type: (
        PlansListGetResponseDataItemAttributesCalculationType | Unset
    ) = UNSET
    ...
    home_page_content: (
        PlansListGetResponseDataItemAttributesHomePageContent | Unset
    ) = UNSET
    id: str | Unset = UNSET
