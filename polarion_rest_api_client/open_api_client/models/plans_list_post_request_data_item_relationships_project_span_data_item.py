...
class PlansListPostRequestDataItemRelationshipsProjectSpanDataItem:
    ...
    Attributes:
        ...
        type_ (PlansListPostRequestDataItemRelationshipsProjectSpanDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListPostRequestDataItemRelationshipsProjectSpanDataItemType(
                _type_
            )
        ...
        plans_list_post_request_data_item_relationships_project_span_data_item_obj.additional_properties = d
