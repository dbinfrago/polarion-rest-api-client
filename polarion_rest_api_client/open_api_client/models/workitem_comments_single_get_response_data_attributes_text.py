...
class WorkitemCommentsSingleGetResponseDataAttributesText:
    """
    Attributes:
        type_ (WorkitemCommentsSingleGetResponseDataAttributesTextType | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_single_get_response_data_attributes_text_obj.additional_properties = d
