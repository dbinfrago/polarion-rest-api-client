...
if TYPE_CHECKING:
    from ..models.page_attachments_single_get_response_data_meta_errors_item_source_resource import (
        PageAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource,
    )


T = TypeVar(
    "T", bound="PageAttachmentsSingleGetResponseDataMetaErrorsItemSource"
)


@_attrs_define
class PageAttachmentsSingleGetResponseDataMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (PageAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = PageAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        page_attachments_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
