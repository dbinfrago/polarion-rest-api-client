...
class FeatureselectionsListGetResponseDataItem:
    """
    Attributes:
        type_ (FeatureselectionsListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/included/MyProjectId/MyWorkItemId.
        revision (str | Unset):  Example: 1234.
        attributes (FeatureselectionsListGetResponseDataItemAttributes | Unset):
        relationships (FeatureselectionsListGetResponseDataItemRelationships | Unset):
        links (FeatureselectionsListGetResponseDataItemLinks | Unset):
        meta (FeatureselectionsListGetResponseDataItemMeta | Unset):
    """

    type_: FeatureselectionsListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    relationships: (
        FeatureselectionsListGetResponseDataItemRelationships | Unset
    ) = UNSET
    links: FeatureselectionsListGetResponseDataItemLinks | Unset = UNSET
    meta: FeatureselectionsListGetResponseDataItemMeta | Unset = UNSET
