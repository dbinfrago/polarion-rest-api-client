...
from ..models.teststeps_single_patch_request_data_attributes_values_item_type import (
    TeststepsSinglePatchRequestDataAttributesValuesItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TeststepsSinglePatchRequestDataAttributesValuesItem")
...
class TeststepsSinglePatchRequestDataAttributesValuesItem:
    """
    Attributes:
        type_ (TeststepsSinglePatchRequestDataAttributesValuesItemType | Unset):
