...
class FeatureselectionsListGetResponse:
    """
    Attributes:
        data (list[FeatureselectionsListGetResponseDataItem] | Unset):
        included (list[FeatureselectionsListGetResponseIncludedItem] | Unset): Related entities might be returned, see
            ...
            Guide</a>.
        links (FeatureselectionsListGetResponseLinks | Unset):
        meta (FeatureselectionsListGetResponseMeta | Unset):
    """

    data: list[FeatureselectionsListGetResponseDataItem] | Unset = UNSET
    included: list[FeatureselectionsListGetResponseIncludedItem] | Unset = (
        UNSET
    )
    links: FeatureselectionsListGetResponseLinks | Unset = UNSET
    meta: FeatureselectionsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        included: (
            list[FeatureselectionsListGetResponseIncludedItem] | Unset
        ) = UNSET
