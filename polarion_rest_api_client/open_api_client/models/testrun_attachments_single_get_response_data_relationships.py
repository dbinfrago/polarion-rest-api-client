...
class TestrunAttachmentsSingleGetResponseDataRelationships:
    """
    Attributes:
        author (TestrunAttachmentsSingleGetResponseDataRelationshipsAuthor | Unset):
        project (TestrunAttachmentsSingleGetResponseDataRelationshipsProject | Unset):
    """

    author: (
        TestrunAttachmentsSingleGetResponseDataRelationshipsAuthor | Unset
    ) = UNSET
    project: (
        TestrunAttachmentsSingleGetResponseDataRelationshipsProject | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_single_get_response_data_relationships_obj.additional_properties = d
