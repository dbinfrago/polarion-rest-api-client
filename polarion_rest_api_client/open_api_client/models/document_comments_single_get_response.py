...
class DocumentCommentsSingleGetResponse:
    """
    Attributes:
        data (DocumentCommentsSingleGetResponseData | Unset):
        included (list[DocumentCommentsSingleGetResponseIncludedItem] | Unset): Related entities might be returned, see
            ...
            Guide</a>.
        links (DocumentCommentsSingleGetResponseLinks | Unset):
    """

    data: DocumentCommentsSingleGetResponseData | Unset = UNSET
    included: list[DocumentCommentsSingleGetResponseIncludedItem] | Unset = (
        UNSET
    )
    links: DocumentCommentsSingleGetResponseLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        included: (
            list[DocumentCommentsSingleGetResponseIncludedItem] | Unset
        ) = UNSET
