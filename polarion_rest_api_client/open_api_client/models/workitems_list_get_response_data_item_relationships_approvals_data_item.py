...
from ..models.workitems_list_get_response_data_item_relationships_approvals_data_item_type import (
    WorkitemsListGetResponseDataItemRelationshipsApprovalsDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="WorkitemsListGetResponseDataItemRelationshipsApprovalsDataItem"
)
...
class WorkitemsListGetResponseDataItemRelationshipsApprovalsDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsListGetResponseDataItemRelationshipsApprovalsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListGetResponseDataItemRelationshipsApprovalsDataItemType(
                _type_
            )

        workitems_list_get_response_data_item_relationships_approvals_data_item_obj = cls(
            id=id,
            revision=revision,
            type_=type_,
        )
