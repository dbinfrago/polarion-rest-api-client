...
T = TypeVar("T", bound="PostTestRecordAttachmentsRequestBody")
...
class PostTestRecordAttachmentsRequestBody:
    ...
    Attributes:
        ...
        resource (TestrecordAttachmentsListPostRequest | Unset):
    """

    files: list[File] | Unset = UNSET
    resource: TestrecordAttachmentsListPostRequest | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = TestrecordAttachmentsListPostRequest.from_dict(
                _resource
            )

        post_test_record_attachments_request_body_obj = cls(
            files=files,
            resource=resource,
        )

        post_test_record_attachments_request_body_obj.additional_properties = d
