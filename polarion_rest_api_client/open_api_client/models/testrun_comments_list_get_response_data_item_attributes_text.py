...
class TestrunCommentsListGetResponseDataItemAttributesText:
    """
    Attributes:
        type_ (TestrunCommentsListGetResponseDataItemAttributesTextType | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunCommentsListGetResponseDataItemAttributesTextType(
                _type_
            )
        ...
        testrun_comments_list_get_response_data_item_attributes_text_obj.additional_properties = d
