...
class WorkitemsListGetResponseDataItemRelationshipsComments:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsCommentsDataItem] | Unset):
        links (WorkitemsListGetResponseDataItemRelationshipsCommentsLinks | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsCommentsMeta | Unset):
    """
    ...
    links: (
        WorkitemsListGetResponseDataItemRelationshipsCommentsLinks | Unset
    ) = UNSET
    meta: WorkitemsListGetResponseDataItemRelationshipsCommentsMeta | Unset = (
        UNSET
    )
