...
class TestrunAttachmentsListPostRequestDataItem:
    """
    Attributes:
        type_ (TestrunAttachmentsListPostRequestDataItemType | Unset):
        attributes (TestrunAttachmentsListPostRequestDataItemAttributes | Unset):
        lid (str | Unset):
    """

    type_: TestrunAttachmentsListPostRequestDataItemType | Unset = UNSET
    attributes: TestrunAttachmentsListPostRequestDataItemAttributes | Unset = (
        UNSET
    )
    lid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunAttachmentsListPostRequestDataItemType(_type_)
        ...
        testrun_attachments_list_post_request_data_item_obj.additional_properties = d
