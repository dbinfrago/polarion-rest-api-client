...
T = TypeVar("T", bound="PageAttachmentsListPostResponseDataItemLinks")
...
class PageAttachmentsListPostResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_attachments_list_post_response_data_item_links_obj = cls(
            content=content,
            self_=self_,
        )

        page_attachments_list_post_response_data_item_links_obj.additional_properties = d
        return page_attachments_list_post_response_data_item_links_obj
