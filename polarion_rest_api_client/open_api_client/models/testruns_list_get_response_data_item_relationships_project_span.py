...
class TestrunsListGetResponseDataItemRelationshipsProjectSpan:
    """
    Attributes:
        data (list[TestrunsListGetResponseDataItemRelationshipsProjectSpanDataItem] | Unset):
        meta (TestrunsListGetResponseDataItemRelationshipsProjectSpanMeta | Unset):
    """

    data: (
        list[TestrunsListGetResponseDataItemRelationshipsProjectSpanDataItem]
        | Unset
    ) = UNSET
    meta: (
        TestrunsListGetResponseDataItemRelationshipsProjectSpanMeta | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_get_response_data_item_relationships_project_span_obj.additional_properties = d
        return (
            testruns_list_get_response_data_item_relationships_project_span_obj
        )
