...
class UsersListGetResponseDataItemRelationshipsProjectRolesDataItem:
    ...
    Attributes:
        ...
        type_ (UsersListGetResponseDataItemRelationshipsProjectRolesDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UsersListGetResponseDataItemRelationshipsProjectRolesDataItemType(
                _type_
            )
        ...
        users_list_get_response_data_item_relationships_project_roles_data_item_obj.additional_properties = d
