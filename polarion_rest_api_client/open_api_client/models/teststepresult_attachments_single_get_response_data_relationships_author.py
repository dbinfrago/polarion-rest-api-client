...
T = TypeVar(
    "T",
    bound="TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthor",
)
...
class TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthor:
    """
    Attributes:
        data (TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthorData | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthorData.from_dict(
                _data
            )

        teststepresult_attachments_single_get_response_data_relationships_author_obj = cls(
            data=data,
        )
