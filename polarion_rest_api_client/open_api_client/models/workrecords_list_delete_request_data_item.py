...
class WorkrecordsListDeleteRequestDataItem:
    """
    Attributes:
        type_ (WorkrecordsListDeleteRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyWorkRecordId.
    """

    type_: WorkrecordsListDeleteRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkrecordsListDeleteRequestDataItemType(_type_)
