...
class UsersListPostRequestDataItemAttributesDescription:
    """
    Attributes:
        type_ (UsersListPostRequestDataItemAttributesDescriptionType | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UsersListPostRequestDataItemAttributesDescriptionType(
                _type_
            )
        ...
        users_list_post_request_data_item_attributes_description_obj.additional_properties = d
