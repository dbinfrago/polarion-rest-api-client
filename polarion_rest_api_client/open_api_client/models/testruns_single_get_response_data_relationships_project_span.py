...
class TestrunsSingleGetResponseDataRelationshipsProjectSpan:
    """
    Attributes:
        data (list[TestrunsSingleGetResponseDataRelationshipsProjectSpanDataItem] | Unset):
        meta (TestrunsSingleGetResponseDataRelationshipsProjectSpanMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_get_response_data_relationships_project_span_obj.additional_properties = d
