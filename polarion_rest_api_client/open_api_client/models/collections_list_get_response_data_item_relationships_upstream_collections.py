...
class CollectionsListGetResponseDataItemRelationshipsUpstreamCollections:
    """
    Attributes:
        data (list[CollectionsListGetResponseDataItemRelationshipsUpstreamCollectionsDataItem] | Unset):
        meta (CollectionsListGetResponseDataItemRelationshipsUpstreamCollectionsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_get_response_data_item_relationships_upstream_collections_obj.additional_properties = d
