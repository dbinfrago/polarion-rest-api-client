...
class TestrecordsListGetResponse:
    """
    Attributes:
        data (list[TestrecordsListGetResponseDataItem] | Unset):
        included (list[TestrecordsListGetResponseIncludedItem] | Unset): Related entities might be returned, see <a
            ...
            Guide</a>.
        links (TestrecordsListGetResponseLinks | Unset):
        meta (TestrecordsListGetResponseMeta | Unset):
    """

    data: list[TestrecordsListGetResponseDataItem] | Unset = UNSET
    included: list[TestrecordsListGetResponseIncludedItem] | Unset = UNSET
    links: TestrecordsListGetResponseLinks | Unset = UNSET
    meta: TestrecordsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _included is not UNSET:
            ...
            for included_item_data in _included:
                included_item = (
                    TestrecordsListGetResponseIncludedItem.from_dict(
                        included_item_data
                    )
                )
