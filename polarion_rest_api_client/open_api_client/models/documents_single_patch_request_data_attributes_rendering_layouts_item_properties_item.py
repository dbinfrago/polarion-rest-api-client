...
T = TypeVar(
    "T",
    bound="DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItemPropertiesItem",
)
...
class DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItemPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_patch_request_data_attributes_rendering_layouts_item_properties_item_obj = cls(
            key=key,
            value=value,
        )
