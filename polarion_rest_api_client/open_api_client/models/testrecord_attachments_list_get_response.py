...
class TestrecordAttachmentsListGetResponse:
    """
    Attributes:
        data (list[TestrecordAttachmentsListGetResponseDataItem] | Unset):
        included (list[TestrecordAttachmentsListGetResponseIncludedItem] | Unset): Related entities might be returned,
            ...
            Guide</a>.
        links (TestrecordAttachmentsListGetResponseLinks | Unset):
        meta (TestrecordAttachmentsListGetResponseMeta | Unset):
    """

    data: list[TestrecordAttachmentsListGetResponseDataItem] | Unset = UNSET
    included: (
        list[TestrecordAttachmentsListGetResponseIncludedItem] | Unset
    ) = UNSET
    links: TestrecordAttachmentsListGetResponseLinks | Unset = UNSET
    meta: TestrecordAttachmentsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = (
                    TestrecordAttachmentsListGetResponseDataItem.from_dict(
                        data_item_data
                    )
                )
