...
if TYPE_CHECKING:
    from ..models.usergroups_single_get_response_data_meta_errors_item_source_resource import (
        UsergroupsSingleGetResponseDataMetaErrorsItemSourceResource,
    )


T = TypeVar("T", bound="UsergroupsSingleGetResponseDataMetaErrorsItemSource")


@_attrs_define
class UsergroupsSingleGetResponseDataMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (UsergroupsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        UsergroupsSingleGetResponseDataMetaErrorsItemSourceResource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = UsergroupsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        usergroups_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
