...
class TestrecordsListPostRequestDataItemRelationshipsDefect:
    """
    Attributes:
        data (TestrecordsListPostRequestDataItemRelationshipsDefectData | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_post_request_data_item_relationships_defect_obj.additional_properties = d
