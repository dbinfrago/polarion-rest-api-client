...
from ..models.testparameters_list_post_request_data_item_type import (
    TestparametersListPostRequestDataItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.testparameters_list_post_request_data_item_attributes import (
        TestparametersListPostRequestDataItemAttributes,
    )


T = TypeVar("T", bound="TestparametersListPostRequestDataItem")
...
class TestparametersListPostRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TestparametersListPostRequestDataItemAttributes.from_dict(
                    _attributes
                )
            )

        testparameters_list_post_request_data_item_obj = cls(
            type_=type_,
            attributes=attributes,
        )

        testparameters_list_post_request_data_item_obj.additional_properties = d
        return testparameters_list_post_request_data_item_obj
