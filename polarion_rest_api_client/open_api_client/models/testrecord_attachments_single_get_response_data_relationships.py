...
class TestrecordAttachmentsSingleGetResponseDataRelationships:
    """
    Attributes:
        author (TestrecordAttachmentsSingleGetResponseDataRelationshipsAuthor | Unset):
        project (TestrecordAttachmentsSingleGetResponseDataRelationshipsProject | Unset):
    """

    author: (
        TestrecordAttachmentsSingleGetResponseDataRelationshipsAuthor | Unset
    ) = UNSET
    project: (
        TestrecordAttachmentsSingleGetResponseDataRelationshipsProject | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_single_get_response_data_relationships_obj.additional_properties = d
        return (
            testrecord_attachments_single_get_response_data_relationships_obj
        )
