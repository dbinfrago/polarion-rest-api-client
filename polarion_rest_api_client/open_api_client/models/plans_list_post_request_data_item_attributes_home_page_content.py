...
class PlansListPostRequestDataItemAttributesHomePageContent:
    """
    Attributes:
        type_ (PlansListPostRequestDataItemAttributesHomePageContentType | Unset):
        value (str | Unset):  Example: My text value.
    """

    type_: (
        PlansListPostRequestDataItemAttributesHomePageContentType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListPostRequestDataItemAttributesHomePageContentType(
                _type_
            )
