...
class DocumentsSingleGetResponseDataRelationshipsUpdatedBy:
    """
    Attributes:
        data (DocumentsSingleGetResponseDataRelationshipsUpdatedByData | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_get_response_data_relationships_updated_by_obj = cls(
            data=data,
        )

        documents_single_get_response_data_relationships_updated_by_obj.additional_properties = d
        return documents_single_get_response_data_relationships_updated_by_obj
