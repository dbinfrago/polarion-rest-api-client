...
if TYPE_CHECKING:
    ...
    from ..models.workitems_single_get_response_data_attributes_hyperlinks_item import (
...
class WorkitemsSingleGetResponseDataAttributes:
    ...
    Attributes:
        ...
        description (WorkitemsSingleGetResponseDataAttributesDescription | Unset):
        due_date (datetime.date | Unset):  Example: 1970-01-01.
        hyperlinks (list[WorkitemsSingleGetResponseDataAttributesHyperlinksItem] | Unset):
    ...
    description: (
        WorkitemsSingleGetResponseDataAttributesDescription | Unset
    ) = UNSET
    due_date: datetime.date | Unset = UNSET
    hyperlinks: (
        list[WorkitemsSingleGetResponseDataAttributesHyperlinksItem] | Unset
    ) = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                WorkitemsSingleGetResponseDataAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        hyperlinks: (
            list[WorkitemsSingleGetResponseDataAttributesHyperlinksItem]
            | Unset
        ) = UNSET
        if _hyperlinks is not UNSET:
            hyperlinks = []
            for hyperlinks_item_data in _hyperlinks:
                hyperlinks_item = WorkitemsSingleGetResponseDataAttributesHyperlinksItem.from_dict(
