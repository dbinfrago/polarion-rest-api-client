...
class WorkitemsListPatchRequestDataItemRelationshipsVotesDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListPatchRequestDataItemRelationshipsVotesDataItemType(
                _type_
            )
        ...
        workitems_list_patch_request_data_item_relationships_votes_data_item_obj.additional_properties = d
