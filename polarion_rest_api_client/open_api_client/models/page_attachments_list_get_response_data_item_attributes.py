...
T = TypeVar("T", bound="PageAttachmentsListGetResponseDataItemAttributes")


@_attrs_define
class PageAttachmentsListGetResponseDataItemAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_attachments_list_get_response_data_item_attributes_obj = cls(
            file_name=file_name,
            id=id,
            length=length,
            title=title,
        ...
        page_attachments_list_get_response_data_item_attributes_obj.additional_properties = d
        return page_attachments_list_get_response_data_item_attributes_obj
