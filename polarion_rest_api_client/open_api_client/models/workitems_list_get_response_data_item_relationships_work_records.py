...
class WorkitemsListGetResponseDataItemRelationshipsWorkRecords:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsWorkRecordsDataItem] | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsWorkRecordsMeta | Unset):
    """

    data: (
        list[WorkitemsListGetResponseDataItemRelationshipsWorkRecordsDataItem]
        | Unset
    ) = UNSET
    meta: (
        WorkitemsListGetResponseDataItemRelationshipsWorkRecordsMeta | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_work_records_obj.additional_properties = d
