...
T = TypeVar(
    "T",
    bound="EnumerationsListPostRequestDataItemAttributesOptionsItemLinkRulesItem",
)


@_attrs_define
class EnumerationsListPostRequestDataItemAttributesOptionsItemLinkRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_list_post_request_data_item_attributes_options_item_link_rules_item_obj = cls(
            from_types=from_types,
            same_type=same_type,
            to_types=to_types,
        )

        enumerations_list_post_request_data_item_attributes_options_item_link_rules_item_obj.additional_properties = d
        return enumerations_list_post_request_data_item_attributes_options_item_link_rules_item_obj
