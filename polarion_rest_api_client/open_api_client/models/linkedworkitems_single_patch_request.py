...
if TYPE_CHECKING:
    from ..models.linkedworkitems_single_patch_request_data import (
        LinkedworkitemsSinglePatchRequestData,
    )


T = TypeVar("T", bound="LinkedworkitemsSinglePatchRequest")
...
class LinkedworkitemsSinglePatchRequest:
    """
    Attributes:
        data (LinkedworkitemsSinglePatchRequestData | Unset):
    """

    data: LinkedworkitemsSinglePatchRequestData | Unset = UNSET
