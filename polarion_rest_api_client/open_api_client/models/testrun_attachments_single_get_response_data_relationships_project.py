...
class TestrunAttachmentsSingleGetResponseDataRelationshipsProject:
    """
    Attributes:
        data (TestrunAttachmentsSingleGetResponseDataRelationshipsProjectData | Unset):
    """

    data: (
        TestrunAttachmentsSingleGetResponseDataRelationshipsProjectData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_single_get_response_data_relationships_project_obj.additional_properties = d
