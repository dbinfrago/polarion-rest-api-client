...
class TeststepResultsSingleGetResponseDataRelationshipsTestStepData:
    ...
    Attributes:
        ...
        type_ (TeststepResultsSingleGetResponseDataRelationshipsTestStepDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepResultsSingleGetResponseDataRelationshipsTestStepDataType(
                _type_
            )
        ...
        teststep_results_single_get_response_data_relationships_test_step_data_obj.additional_properties = d
