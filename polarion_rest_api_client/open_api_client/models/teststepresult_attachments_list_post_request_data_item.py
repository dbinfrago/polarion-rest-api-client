...
class TeststepresultAttachmentsListPostRequestDataItem:
    """
    Attributes:
        type_ (TeststepresultAttachmentsListPostRequestDataItemType | Unset):
        attributes (TeststepresultAttachmentsListPostRequestDataItemAttributes | Unset):
        lid (str | Unset):
    """

    type_: TeststepresultAttachmentsListPostRequestDataItemType | Unset = UNSET
    attributes: (
        TeststepresultAttachmentsListPostRequestDataItemAttributes | Unset
    ) = UNSET
    lid: str | Unset = UNSET
