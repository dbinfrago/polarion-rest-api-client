...
class CollectionsSinglePatchRequestDataRelationshipsUpstreamCollections:
    """
    Attributes:
        data (list[CollectionsSinglePatchRequestDataRelationshipsUpstreamCollectionsDataItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_patch_request_data_relationships_upstream_collections_obj.additional_properties = d
