...
class WorkitemsListGetResponseDataItemRelationshipsAttachments:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsAttachmentsDataItem] | Unset):
        links (WorkitemsListGetResponseDataItemRelationshipsAttachmentsLinks | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsAttachmentsMeta | Unset):
    """

    data: (
        list[WorkitemsListGetResponseDataItemRelationshipsAttachmentsDataItem]
        | Unset
    ) = UNSET
    links: (
        WorkitemsListGetResponseDataItemRelationshipsAttachmentsLinks | Unset
    ) = UNSET
    meta: (
        WorkitemsListGetResponseDataItemRelationshipsAttachmentsMeta | Unset
    ) = UNSET
