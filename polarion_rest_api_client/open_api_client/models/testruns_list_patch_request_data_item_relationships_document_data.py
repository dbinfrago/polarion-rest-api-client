...
class TestrunsListPatchRequestDataItemRelationshipsDocumentData:
    ...
    Attributes:
        ...
        type_ (TestrunsListPatchRequestDataItemRelationshipsDocumentDataType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        TestrunsListPatchRequestDataItemRelationshipsDocumentDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_patch_request_data_item_relationships_document_data_obj.additional_properties = d
