...
class TestrunsSingleGetResponseDataMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (TestrunsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: (
        TestrunsSingleGetResponseDataMetaErrorsItemSourceResource | Unset
    ) = UNSET
