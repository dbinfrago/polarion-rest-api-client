...
if TYPE_CHECKING:
    from ..models.projects_list_get_response_data_item_meta_errors_item_source_resource import (
        ProjectsListGetResponseDataItemMetaErrorsItemSourceResource,
    )


T = TypeVar("T", bound="ProjectsListGetResponseDataItemMetaErrorsItemSource")
...
class ProjectsListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = ProjectsListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                _resource
            )

        projects_list_get_response_data_item_meta_errors_item_source_obj = cls(
            parameter=parameter,
            pointer=pointer,
            resource=resource,
        )

        projects_list_get_response_data_item_meta_errors_item_source_obj.additional_properties = d
        return projects_list_get_response_data_item_meta_errors_item_source_obj
