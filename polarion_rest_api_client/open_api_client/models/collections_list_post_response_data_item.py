...
class CollectionsListPostResponseDataItem:
    """
    Attributes:
        type_ (CollectionsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyCollectionId.
        links (CollectionsListPostResponseDataItemLinks | Unset):
    """

    type_: CollectionsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: CollectionsListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = CollectionsListPostResponseDataItemType(_type_)
