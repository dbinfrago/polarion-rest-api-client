...
class TestrunsSingleGetResponseDataAttributesHomePageContent:
    """
    Attributes:
        type_ (TestrunsSingleGetResponseDataAttributesHomePageContentType | Unset):
        value (str | Unset):  Example: My text value.
    """

    type_: (
        TestrunsSingleGetResponseDataAttributesHomePageContentType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunsSingleGetResponseDataAttributesHomePageContentType(
                _type_
            )
