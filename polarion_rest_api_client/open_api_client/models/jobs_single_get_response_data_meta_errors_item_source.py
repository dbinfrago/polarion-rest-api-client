...
class JobsSingleGetResponseDataMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (JobsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing the error.
    """

    parameter: str | Unset = UNSET
    pointer: str | Unset = UNSET
    resource: JobsSingleGetResponseDataMetaErrorsItemSourceResource | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
