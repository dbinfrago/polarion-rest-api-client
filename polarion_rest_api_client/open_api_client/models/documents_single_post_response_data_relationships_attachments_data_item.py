...
T = TypeVar(
    "T",
    bound="DocumentsSinglePostResponseDataRelationshipsAttachmentsDataItem",
)
...
class DocumentsSinglePostResponseDataRelationshipsAttachmentsDataItem:
    ...
    Attributes:
        ...
        type_ (DocumentsSinglePostResponseDataRelationshipsAttachmentsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_post_response_data_relationships_attachments_data_item_obj.additional_properties = d
