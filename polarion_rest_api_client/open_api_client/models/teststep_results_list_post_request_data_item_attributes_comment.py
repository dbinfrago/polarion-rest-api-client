...
class TeststepResultsListPostRequestDataItemAttributesComment:
    """
    Attributes:
        type_ (TeststepResultsListPostRequestDataItemAttributesCommentType | Unset):
        value (str | Unset):  Example: My text value.
    """

    type_: (
        TeststepResultsListPostRequestDataItemAttributesCommentType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_list_post_request_data_item_attributes_comment_obj.additional_properties = d
        return (
            teststep_results_list_post_request_data_item_attributes_comment_obj
        )
