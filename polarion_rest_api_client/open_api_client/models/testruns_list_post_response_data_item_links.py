...
T = TypeVar("T", bound="TestrunsListPostResponseDataItemLinks")
...
class TestrunsListPostResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_post_response_data_item_links_obj = cls(
            portal=portal,
            self_=self_,
        )

        testruns_list_post_response_data_item_links_obj.additional_properties = d
        return testruns_list_post_response_data_item_links_obj
