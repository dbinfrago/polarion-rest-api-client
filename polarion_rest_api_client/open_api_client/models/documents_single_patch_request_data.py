...
class DocumentsSinglePatchRequestData:
    """
    Attributes:
        type_ (DocumentsSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MySpaceId/MyDocumentId.
        attributes (DocumentsSinglePatchRequestDataAttributes | Unset):
    """

    type_: DocumentsSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: DocumentsSinglePatchRequestDataAttributes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentsSinglePatchRequestDataType(_type_)
