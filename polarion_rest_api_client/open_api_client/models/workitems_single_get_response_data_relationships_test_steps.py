...
class WorkitemsSingleGetResponseDataRelationshipsTestSteps:
    """
    Attributes:
        data (list[WorkitemsSingleGetResponseDataRelationshipsTestStepsDataItem] | Unset):
        meta (WorkitemsSingleGetResponseDataRelationshipsTestStepsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_test_steps_obj.additional_properties = d
