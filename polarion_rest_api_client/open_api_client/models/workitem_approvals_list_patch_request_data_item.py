...
class WorkitemApprovalsListPatchRequestDataItem:
    """
    Attributes:
        type_ (WorkitemApprovalsListPatchRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyUserId.
        attributes (WorkitemApprovalsListPatchRequestDataItemAttributes | Unset):
    """

    type_: WorkitemApprovalsListPatchRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: WorkitemApprovalsListPatchRequestDataItemAttributes | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemApprovalsListPatchRequestDataItemType(_type_)
        ...
        workitem_approvals_list_patch_request_data_item_obj.additional_properties = d
