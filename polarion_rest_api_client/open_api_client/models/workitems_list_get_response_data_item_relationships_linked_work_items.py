...
class WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItems:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsDataItem] | Unset):
        links (WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsLinks | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_linked_work_items_obj.additional_properties = d
