...
if TYPE_CHECKING:
    from ..models.testrun_comments_list_get_response_data_item_attributes_text import (
        TestrunCommentsListGetResponseDataItemAttributesText,
    )


T = TypeVar("T", bound="TestrunCommentsListGetResponseDataItemAttributes")


@_attrs_define
class TestrunCommentsListGetResponseDataItemAttributes:
    """
    Attributes:
        created (datetime.datetime | Unset):  Example: 1970-01-01T00:00:00Z.
        id (str | Unset):  Example: MyCommentId.
        resolved (bool | Unset):
        text (TestrunCommentsListGetResponseDataItemAttributesText | Unset):
    ...
    text: TestrunCommentsListGetResponseDataItemAttributesText | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_text, Unset):
            ...
            text = (
                TestrunCommentsListGetResponseDataItemAttributesText.from_dict(
                    _text
                )
            )
        ...
        testrun_comments_list_get_response_data_item_attributes_obj = cls(
            created=created,
            id=id,
            resolved=resolved,
            text=text,
