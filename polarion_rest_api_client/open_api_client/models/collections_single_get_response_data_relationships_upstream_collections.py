...
class CollectionsSingleGetResponseDataRelationshipsUpstreamCollections:
    """
    Attributes:
        data (list[CollectionsSingleGetResponseDataRelationshipsUpstreamCollectionsDataItem] | Unset):
        meta (CollectionsSingleGetResponseDataRelationshipsUpstreamCollectionsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_get_response_data_relationships_upstream_collections_obj.additional_properties = d
