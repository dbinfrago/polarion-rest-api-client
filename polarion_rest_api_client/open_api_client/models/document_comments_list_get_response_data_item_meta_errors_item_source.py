...
if TYPE_CHECKING:
    from ..models.document_comments_list_get_response_data_item_meta_errors_item_source_resource import (
        DocumentCommentsListGetResponseDataItemMetaErrorsItemSourceResource,
    )


T = TypeVar(
    "T", bound="DocumentCommentsListGetResponseDataItemMetaErrorsItemSource"
)


@_attrs_define
class DocumentCommentsListGetResponseDataItemMetaErrorsItemSource:
    """
    Attributes:
        ...
        resource (DocumentCommentsListGetResponseDataItemMetaErrorsItemSourceResource | Unset): Resource causing the
            error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DocumentCommentsListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        document_comments_list_get_response_data_item_meta_errors_item_source_obj.additional_properties = d
