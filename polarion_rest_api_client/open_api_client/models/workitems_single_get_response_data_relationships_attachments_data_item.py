...
T = TypeVar(
    "T", bound="WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItem"
)
...
class WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItemType(
                _type_
            )
        ...
        workitems_single_get_response_data_relationships_attachments_data_item_obj.additional_properties = d
