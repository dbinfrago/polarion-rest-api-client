...
class TestrecordAttachmentsListGetResponseDataItemMetaErrorsItem:
    ...
    Attributes:
        ...
        source (TestrecordAttachmentsListGetResponseDataItemMetaErrorsItemSource | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_get_response_data_item_meta_errors_item_obj.additional_properties = d
