...
class WorkitemApprovalsSinglePatchRequestDataAttributes:
    """
    Attributes:
        status (WorkitemApprovalsSinglePatchRequestDataAttributesStatus | Unset):  Example: waiting.
    """

    status: WorkitemApprovalsSinglePatchRequestDataAttributesStatus | Unset = (
        UNSET
    )
