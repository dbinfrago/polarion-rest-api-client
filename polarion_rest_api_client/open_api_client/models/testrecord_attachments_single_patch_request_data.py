...
class TestrecordAttachmentsSinglePatchRequestData:
    """
    Attributes:
        type_ (TestrecordAttachmentsSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyProjectId/MyTestcaseId/0/MyAttachmentId.
        attributes (TestrecordAttachmentsSinglePatchRequestDataAttributes | Unset):
    """

    type_: TestrecordAttachmentsSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: (
        TestrecordAttachmentsSinglePatchRequestDataAttributes | Unset
    ) = UNSET
