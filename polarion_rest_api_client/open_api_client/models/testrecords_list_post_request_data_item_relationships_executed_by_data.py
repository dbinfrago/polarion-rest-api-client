...
class TestrecordsListPostRequestDataItemRelationshipsExecutedByData:
    ...
    Attributes:
        ...
        type_ (TestrecordsListPostRequestDataItemRelationshipsExecutedByDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrecordsListPostRequestDataItemRelationshipsExecutedByDataType(
                _type_
            )
        ...
        testrecords_list_post_request_data_item_relationships_executed_by_data_obj.additional_properties = d
