...
class TestparameterDefinitionsSingleGetResponse:
    """
    Attributes:
        data (TestparameterDefinitionsSingleGetResponseData | Unset):
        included (list[TestparameterDefinitionsSingleGetResponseIncludedItem] | Unset): Related entities might be
            ...
            Guide</a>.
        links (TestparameterDefinitionsSingleGetResponseLinks | Unset):
    """

    data: TestparameterDefinitionsSingleGetResponseData | Unset = UNSET
    included: (
        list[TestparameterDefinitionsSingleGetResponseIncludedItem] | Unset
    ) = UNSET
    links: TestparameterDefinitionsSingleGetResponseLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testparameter_definitions_single_get_response_obj.additional_properties = d
