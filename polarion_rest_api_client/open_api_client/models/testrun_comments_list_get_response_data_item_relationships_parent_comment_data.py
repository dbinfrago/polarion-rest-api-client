...
T = TypeVar(
    "T",
    bound="TestrunCommentsListGetResponseDataItemRelationshipsParentCommentData",
)
...
class TestrunCommentsListGetResponseDataItemRelationshipsParentCommentData:
    ...
    Attributes:
        ...
        type_ (TestrunCommentsListGetResponseDataItemRelationshipsParentCommentDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_comments_list_get_response_data_item_relationships_parent_comment_data_obj.additional_properties = d
        return testrun_comments_list_get_response_data_item_relationships_parent_comment_data_obj
