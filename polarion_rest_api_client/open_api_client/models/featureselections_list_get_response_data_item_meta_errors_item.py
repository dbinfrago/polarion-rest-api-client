...
T = TypeVar(
    "T", bound="FeatureselectionsListGetResponseDataItemMetaErrorsItem"
)
...
class FeatureselectionsListGetResponseDataItemMetaErrorsItem:
    ...
    Attributes:
        ...
        source (FeatureselectionsListGetResponseDataItemMetaErrorsItemSource | Unset):
    ...
    source: (
        FeatureselectionsListGetResponseDataItemMetaErrorsItemSource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = FeatureselectionsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                _source
            )
