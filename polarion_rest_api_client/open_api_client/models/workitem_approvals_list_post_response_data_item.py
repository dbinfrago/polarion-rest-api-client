...
from ..models.workitem_approvals_list_post_response_data_item_type import (
    WorkitemApprovalsListPostResponseDataItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.workitem_approvals_list_post_response_data_item_links import (
        WorkitemApprovalsListPostResponseDataItemLinks,
    )


T = TypeVar("T", bound="WorkitemApprovalsListPostResponseDataItem")
...
class WorkitemApprovalsListPostResponseDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemApprovalsListPostResponseDataItemType(_type_)
        ...
        if isinstance(_links, Unset):
            ...
            links = WorkitemApprovalsListPostResponseDataItemLinks.from_dict(
                _links
            )

        workitem_approvals_list_post_response_data_item_obj = cls(
            type_=type_,
            id=id,
            links=links,
        )

        workitem_approvals_list_post_response_data_item_obj.additional_properties = d
