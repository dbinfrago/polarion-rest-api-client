...
T = TypeVar("T", bound="EnumOptionsActionResponseBodyDataItemLinkRulesItem")


@_attrs_define
class EnumOptionsActionResponseBodyDataItemLinkRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enum_options_action_response_body_data_item_link_rules_item_obj = cls(
            from_types=from_types,
            same_type=same_type,
            to_types=to_types,
        )

        enum_options_action_response_body_data_item_link_rules_item_obj.additional_properties = d
        return enum_options_action_response_body_data_item_link_rules_item_obj
