...
class UsersSingleGetResponseData:
    """
    Attributes:
        type_ (UsersSingleGetResponseDataType | Unset):
        id (str | Unset):  Example: MyUserId.
        revision (str | Unset):  Example: 1234.
        attributes (UsersSingleGetResponseDataAttributes | Unset):
        relationships (UsersSingleGetResponseDataRelationships | Unset):
        links (UsersSingleGetResponseDataLinks | Unset):
        meta (UsersSingleGetResponseDataMeta | Unset):
    """

    type_: UsersSingleGetResponseDataType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: UsersSingleGetResponseDataAttributes | Unset = UNSET
    relationships: UsersSingleGetResponseDataRelationships | Unset = UNSET
    links: UsersSingleGetResponseDataLinks | Unset = UNSET
    meta: UsersSingleGetResponseDataMeta | Unset = UNSET
