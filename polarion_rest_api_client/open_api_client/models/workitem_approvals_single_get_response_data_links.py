...
T = TypeVar("T", bound="WorkitemApprovalsSingleGetResponseDataLinks")
...
class WorkitemApprovalsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_approvals_single_get_response_data_links_obj = cls(
            self_=self_,
        )

        workitem_approvals_single_get_response_data_links_obj.additional_properties = d
