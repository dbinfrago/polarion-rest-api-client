...
T = TypeVar("T", bound="TestrunAttachmentsSingleGetResponseDataLinks")


@_attrs_define
class TestrunAttachmentsSingleGetResponseDataLinks:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_single_get_response_data_links_obj = cls(
            content=content,
            self_=self_,
        )

        testrun_attachments_single_get_response_data_links_obj.additional_properties = d
