...
class WorkitemsSingleGetResponseDataRelationshipsBacklinkedWorkItemsDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsSingleGetResponseDataRelationshipsBacklinkedWorkItemsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsSingleGetResponseDataRelationshipsBacklinkedWorkItemsDataItemType(
                _type_
            )
        ...
        workitems_single_get_response_data_relationships_backlinked_work_items_data_item_obj.additional_properties = d
