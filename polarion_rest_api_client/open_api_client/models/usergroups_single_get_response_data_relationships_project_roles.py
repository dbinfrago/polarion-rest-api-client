...
class UsergroupsSingleGetResponseDataRelationshipsProjectRoles:
    """
    Attributes:
        data (list[UsergroupsSingleGetResponseDataRelationshipsProjectRolesDataItem] | Unset):
        meta (UsergroupsSingleGetResponseDataRelationshipsProjectRolesMeta | Unset):
    """

    data: (
        list[UsergroupsSingleGetResponseDataRelationshipsProjectRolesDataItem]
        | Unset
    ) = UNSET
    meta: (
        UsergroupsSingleGetResponseDataRelationshipsProjectRolesMeta | Unset
    ) = UNSET
