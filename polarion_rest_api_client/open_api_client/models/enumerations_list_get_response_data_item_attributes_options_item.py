...
if TYPE_CHECKING:
    from ..models.enumerations_list_get_response_data_item_attributes_options_item_link_rules_item import (
        EnumerationsListGetResponseDataItemAttributesOptionsItemLinkRulesItem,
    )


T = TypeVar(
    "T", bound="EnumerationsListGetResponseDataItemAttributesOptionsItem"
)


@_attrs_define
class EnumerationsListGetResponseDataItemAttributesOptionsItem:
    """
    Attributes:
        ...
        link_rules (list[EnumerationsListGetResponseDataItemAttributesOptionsItemLinkRulesItem] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _link_rules is not UNSET:
            ...
            for link_rules_item_data in _link_rules:
                link_rules_item = EnumerationsListGetResponseDataItemAttributesOptionsItemLinkRulesItem.from_dict(
        ...
        enumerations_list_get_response_data_item_attributes_options_item_obj = cls(
            color=color,
        ...
        enumerations_list_get_response_data_item_attributes_options_item_obj.additional_properties = d
        return enumerations_list_get_response_data_item_attributes_options_item_obj
