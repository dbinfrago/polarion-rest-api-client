...
if TYPE_CHECKING:
    from ..models.documents_list_post_response_data_item_links import (
...
class DocumentsListPostResponseDataItem:
    """
    Attributes:
        type_ (DocumentsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MySpaceId/MyDocumentId.
        links (DocumentsListPostResponseDataItemLinks | Unset):
    """

    type_: DocumentsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: DocumentsListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentsListPostResponseDataItemType(_type_)
