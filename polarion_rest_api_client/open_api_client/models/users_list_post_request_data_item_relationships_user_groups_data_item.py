...
class UsersListPostRequestDataItemRelationshipsUserGroupsDataItem:
    ...
    Attributes:
        ...
        type_ (UsersListPostRequestDataItemRelationshipsUserGroupsDataItemType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        UsersListPostRequestDataItemRelationshipsUserGroupsDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UsersListPostRequestDataItemRelationshipsUserGroupsDataItemType(
                _type_
            )
        ...
        users_list_post_request_data_item_relationships_user_groups_data_item_obj.additional_properties = d
