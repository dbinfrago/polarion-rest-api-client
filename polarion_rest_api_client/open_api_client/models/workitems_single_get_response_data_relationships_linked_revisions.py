...
class WorkitemsSingleGetResponseDataRelationshipsLinkedRevisions:
    """
    Attributes:
        data (list[WorkitemsSingleGetResponseDataRelationshipsLinkedRevisionsDataItem] | Unset):
        meta (WorkitemsSingleGetResponseDataRelationshipsLinkedRevisionsMeta | Unset):
    """
    ...
    meta: (
        WorkitemsSingleGetResponseDataRelationshipsLinkedRevisionsMeta | Unset
    ) = UNSET
