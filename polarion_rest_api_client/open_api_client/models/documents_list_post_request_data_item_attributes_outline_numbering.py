...
T = TypeVar(
    "T", bound="DocumentsListPostRequestDataItemAttributesOutlineNumbering"
)
...
class DocumentsListPostRequestDataItemAttributesOutlineNumbering:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_list_post_request_data_item_attributes_outline_numbering_obj.additional_properties = d
