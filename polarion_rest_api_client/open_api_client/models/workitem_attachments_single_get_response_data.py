...
class WorkitemAttachmentsSingleGetResponseData:
    """
    Attributes:
        type_ (WorkitemAttachmentsSingleGetResponseDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyAttachmentId.
        revision (str | Unset):  Example: 1234.
        attributes (WorkitemAttachmentsSingleGetResponseDataAttributes | Unset):
        relationships (WorkitemAttachmentsSingleGetResponseDataRelationships | Unset):
        links (WorkitemAttachmentsSingleGetResponseDataLinks | Unset):
        meta (WorkitemAttachmentsSingleGetResponseDataMeta | Unset):
    """

    type_: WorkitemAttachmentsSingleGetResponseDataType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    relationships: (
        WorkitemAttachmentsSingleGetResponseDataRelationships | Unset
    ) = UNSET
    links: WorkitemAttachmentsSingleGetResponseDataLinks | Unset = UNSET
    meta: WorkitemAttachmentsSingleGetResponseDataMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_single_get_response_data_obj.additional_properties = d
