...
class PlansSinglePatchRequestDataRelationshipsWorkItems:
    """
    Attributes:
        data (list[PlansSinglePatchRequestDataRelationshipsWorkItemsDataItem] | Unset):
    """

    data: (
        list[PlansSinglePatchRequestDataRelationshipsWorkItemsDataItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plans_single_patch_request_data_relationships_work_items_obj.additional_properties = d
