...
T = TypeVar("T", bound="WorkitemCommentsListGetResponseLinks")


@_attrs_define
class WorkitemCommentsListGetResponseLinks:
    """
    Attributes:
        first (str | Unset):  Example: server-host-name/application-
            path/projects/MyProjectId/workitems/MyWorkItemId/comments?page%5Bsize%5D=10&page%5Bnumber%5D=1.
        last (str | Unset):  Example: server-host-name/application-
            path/projects/MyProjectId/workitems/MyWorkItemId/comments?page%5Bsize%5D=10&page%5Bnumber%5D=9.
        next_ (str | Unset):  Example: server-host-name/application-
            path/projects/MyProjectId/workitems/MyWorkItemId/comments?page%5Bsize%5D=10&page%5Bnumber%5D=6.
        prev (str | Unset):  Example: server-host-name/application-
            path/projects/MyProjectId/workitems/MyWorkItemId/comments?page%5Bsize%5D=10&page%5Bnumber%5D=4.
        self_ (str | Unset):  Example: server-host-name/application-
            path/projects/MyProjectId/workitems/MyWorkItemId/comments?page%5Bsize%5D=10&page%5Bnumber%5D=5.
    """
