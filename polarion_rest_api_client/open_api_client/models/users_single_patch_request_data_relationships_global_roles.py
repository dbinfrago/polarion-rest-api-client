...
class UsersSinglePatchRequestDataRelationshipsGlobalRoles:
    """
    Attributes:
        data (list[UsersSinglePatchRequestDataRelationshipsGlobalRolesDataItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_single_patch_request_data_relationships_global_roles_obj.additional_properties = d
