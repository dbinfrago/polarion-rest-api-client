...
class WorkitemApprovalsListGetResponseDataItemRelationships:
    """
    Attributes:
        user (WorkitemApprovalsListGetResponseDataItemRelationshipsUser | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_approvals_list_get_response_data_item_relationships_obj.additional_properties = d
