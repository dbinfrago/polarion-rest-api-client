...
T = TypeVar(
    "T", bound="DocumentsSingleGetResponseDataRelationshipsCommentsLinks"
)
...
class DocumentsSingleGetResponseDataRelationshipsCommentsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_get_response_data_relationships_comments_links_obj.additional_properties = d
        return (
            documents_single_get_response_data_relationships_comments_links_obj
        )
