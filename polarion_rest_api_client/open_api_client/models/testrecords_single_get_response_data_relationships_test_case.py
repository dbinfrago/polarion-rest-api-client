...
class TestrecordsSingleGetResponseDataRelationshipsTestCase:
    """
    Attributes:
        data (TestrecordsSingleGetResponseDataRelationshipsTestCaseData | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TestrecordsSingleGetResponseDataRelationshipsTestCaseData.from_dict(
                _data
            )

        testrecords_single_get_response_data_relationships_test_case_obj = cls(
            data=data,
        )
