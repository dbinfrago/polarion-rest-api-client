...
if TYPE_CHECKING:
    from ..models.externallylinkedworkitems_single_get_response_data_meta_errors_item_source_resource import (
...
T = TypeVar(
    "T",
    bound="ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSource",
)
...
class ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSourceResource | Unset): Resource causing
            the error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                _resource
            )

        externallylinkedworkitems_single_get_response_data_meta_errors_item_source_obj = cls(
            parameter=parameter,
            pointer=pointer,
            resource=resource,
        )

        externallylinkedworkitems_single_get_response_data_meta_errors_item_source_obj.additional_properties = d
