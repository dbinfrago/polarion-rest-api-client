...
class WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItems:
    """
    Attributes:
        data (list[WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItemsDataItem] | Unset):
        meta (WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItemsMeta | Unset):
    """
