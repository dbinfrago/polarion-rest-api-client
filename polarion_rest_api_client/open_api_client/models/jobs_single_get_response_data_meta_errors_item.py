...
T = TypeVar("T", bound="JobsSingleGetResponseDataMetaErrorsItem")


@_attrs_define
class JobsSingleGetResponseDataMetaErrorsItem:
    """
    Attributes:
        ...
        source (JobsSingleGetResponseDataMetaErrorsItemSource | Unset):
    ...
    source: JobsSingleGetResponseDataMetaErrorsItemSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = JobsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        jobs_single_get_response_data_meta_errors_item_obj = cls(
            detail=detail,
            source=source,
            status=status,
            title=title,
        ...
        jobs_single_get_response_data_meta_errors_item_obj.additional_properties = d
