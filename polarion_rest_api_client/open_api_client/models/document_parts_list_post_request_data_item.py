...
class DocumentPartsListPostRequestDataItem:
    """
    Attributes:
        type_ (DocumentPartsListPostRequestDataItemType | Unset):
        attributes (DocumentPartsListPostRequestDataItemAttributes | Unset):
        relationships (DocumentPartsListPostRequestDataItemRelationships | Unset):
    """

    type_: DocumentPartsListPostRequestDataItemType | Unset = UNSET
    attributes: DocumentPartsListPostRequestDataItemAttributes | Unset = UNSET
    relationships: (
        DocumentPartsListPostRequestDataItemRelationships | Unset
    ) = UNSET
