...
class UsersSingleGetResponseDataRelationshipsGlobalRoles:
    """
    Attributes:
        data (list[UsersSingleGetResponseDataRelationshipsGlobalRolesDataItem] | Unset):
        meta (UsersSingleGetResponseDataRelationshipsGlobalRolesMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_single_get_response_data_relationships_global_roles_obj.additional_properties = d
