...
class TeststepsListPostRequestDataItemAttributesValuesItem:
    """
    Attributes:
        type_ (TeststepsListPostRequestDataItemAttributesValuesItemType | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepsListPostRequestDataItemAttributesValuesItemType(
                _type_
            )
        ...
        teststeps_list_post_request_data_item_attributes_values_item_obj.additional_properties = d
