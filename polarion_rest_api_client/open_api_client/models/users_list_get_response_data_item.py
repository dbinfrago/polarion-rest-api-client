...
class UsersListGetResponseDataItem:
    """
    Attributes:
        type_ (UsersListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyUserId.
        revision (str | Unset):  Example: 1234.
        attributes (UsersListGetResponseDataItemAttributes | Unset):
        relationships (UsersListGetResponseDataItemRelationships | Unset):
        links (UsersListGetResponseDataItemLinks | Unset):
        meta (UsersListGetResponseDataItemMeta | Unset):
    """

    type_: UsersListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: UsersListGetResponseDataItemAttributes | Unset = UNSET
    relationships: UsersListGetResponseDataItemRelationships | Unset = UNSET
    links: UsersListGetResponseDataItemLinks | Unset = UNSET
    meta: UsersListGetResponseDataItemMeta | Unset = UNSET
