...
T = TypeVar("T", bound="WorkitemsListGetResponseDataItemLinks")
...
class WorkitemsListGetResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_links_obj = cls(
            portal=portal,
            self_=self_,
        )

        workitems_list_get_response_data_item_links_obj.additional_properties = d
        return workitems_list_get_response_data_item_links_obj
