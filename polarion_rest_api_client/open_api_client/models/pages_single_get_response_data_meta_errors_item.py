...
if TYPE_CHECKING:
    from ..models.pages_single_get_response_data_meta_errors_item_source import (
        PagesSingleGetResponseDataMetaErrorsItemSource,
    )


T = TypeVar("T", bound="PagesSingleGetResponseDataMetaErrorsItem")


@_attrs_define
class PagesSingleGetResponseDataMetaErrorsItem:
    """
    Attributes:
        ...
        source (PagesSingleGetResponseDataMetaErrorsItemSource | Unset):
    ...
    source: PagesSingleGetResponseDataMetaErrorsItemSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = PagesSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        pages_single_get_response_data_meta_errors_item_obj.additional_properties = d
