...
class WorkitemAttachmentsListGetResponseDataItemMetaErrorsItem:
    ...
    Attributes:
        ...
        source (WorkitemAttachmentsListGetResponseDataItemMetaErrorsItemSource | Unset):
    ...
    source: (
        WorkitemAttachmentsListGetResponseDataItemMetaErrorsItemSource | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_list_get_response_data_item_meta_errors_item_obj = cls(
            detail=detail,
            source=source,
            status=status,
            title=title,
        ...
        workitem_attachments_list_get_response_data_item_meta_errors_item_obj.additional_properties = d
        return workitem_attachments_list_get_response_data_item_meta_errors_item_obj
