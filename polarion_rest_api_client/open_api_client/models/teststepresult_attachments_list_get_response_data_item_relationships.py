...
class TeststepresultAttachmentsListGetResponseDataItemRelationships:
    """
    Attributes:
        author (TeststepresultAttachmentsListGetResponseDataItemRelationshipsAuthor | Unset):
        project (TeststepresultAttachmentsListGetResponseDataItemRelationshipsProject | Unset):
    """
