...
class TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthorData:
    ...
    Attributes:
        ...
        type_ (TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthorDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthorDataType(
                _type_
            )
        ...
        teststepresult_attachments_single_get_response_data_relationships_author_data_obj.additional_properties = d
