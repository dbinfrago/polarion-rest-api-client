...
class CollectionsSingleGetResponseDataRelationshipsProjectData:
    ...
    Attributes:
        ...
        type_ (CollectionsSingleGetResponseDataRelationshipsProjectDataType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        CollectionsSingleGetResponseDataRelationshipsProjectDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_get_response_data_relationships_project_data_obj.additional_properties = d
        return (
            collections_single_get_response_data_relationships_project_data_obj
        )
