...
class JobsSingleGetResponse:
    """
    Attributes:
        data (JobsSingleGetResponseData | Unset):
        included (list[JobsSingleGetResponseIncludedItem] | Unset): Related entities might be returned, see <a
            ...
            Guide</a>.
        links (JobsSingleGetResponseLinks | Unset):
    """

    data: JobsSingleGetResponseData | Unset = UNSET
    included: list[JobsSingleGetResponseIncludedItem] | Unset = UNSET
    links: JobsSingleGetResponseLinks | Unset = UNSET
