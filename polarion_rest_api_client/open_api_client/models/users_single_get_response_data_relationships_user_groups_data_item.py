...
class UsersSingleGetResponseDataRelationshipsUserGroupsDataItem:
    ...
    Attributes:
        ...
        type_ (UsersSingleGetResponseDataRelationshipsUserGroupsDataItemType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        UsersSingleGetResponseDataRelationshipsUserGroupsDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_single_get_response_data_relationships_user_groups_data_item_obj.additional_properties = d
