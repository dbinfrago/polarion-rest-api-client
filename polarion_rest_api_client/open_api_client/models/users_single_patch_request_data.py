...
class UsersSinglePatchRequestData:
    """
    Attributes:
        type_ (UsersSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyUserId.
        attributes (UsersSinglePatchRequestDataAttributes | Unset):
        relationships (UsersSinglePatchRequestDataRelationships | Unset):
    """

    type_: UsersSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: UsersSinglePatchRequestDataAttributes | Unset = UNSET
    relationships: UsersSinglePatchRequestDataRelationships | Unset = UNSET
