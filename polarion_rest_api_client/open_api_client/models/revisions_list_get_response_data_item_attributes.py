...
T = TypeVar("T", bound="RevisionsListGetResponseDataItemAttributes")


@_attrs_define
class RevisionsListGetResponseDataItemAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revisions_list_get_response_data_item_attributes_obj = cls(
            created=created,
            id=id,
        ...
        revisions_list_get_response_data_item_attributes_obj.additional_properties = d
