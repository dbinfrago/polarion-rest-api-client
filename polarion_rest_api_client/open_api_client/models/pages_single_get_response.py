...
class PagesSingleGetResponse:
    """
    Attributes:
        data (PagesSingleGetResponseData | Unset):
        included (list[PagesSingleGetResponseIncludedItem] | Unset): Related entities might be returned, see <a
            ...
            Guide</a>.
        links (PagesSingleGetResponseLinks | Unset):
    """

    data: PagesSingleGetResponseData | Unset = UNSET
    included: list[PagesSingleGetResponseIncludedItem] | Unset = UNSET
    links: PagesSingleGetResponseLinks | Unset = UNSET
