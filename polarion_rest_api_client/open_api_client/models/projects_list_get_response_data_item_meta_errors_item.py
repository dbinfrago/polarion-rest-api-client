...
if TYPE_CHECKING:
    from ..models.projects_list_get_response_data_item_meta_errors_item_source import (
        ProjectsListGetResponseDataItemMetaErrorsItemSource,
    )


T = TypeVar("T", bound="ProjectsListGetResponseDataItemMetaErrorsItem")


@_attrs_define
class ProjectsListGetResponseDataItemMetaErrorsItem:
    """
    Attributes:
        ...
        source (ProjectsListGetResponseDataItemMetaErrorsItemSource | Unset):
    ...
    source: ProjectsListGetResponseDataItemMetaErrorsItemSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                ProjectsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                    _source
                )
            )
        ...
        projects_list_get_response_data_item_meta_errors_item_obj.additional_properties = d
