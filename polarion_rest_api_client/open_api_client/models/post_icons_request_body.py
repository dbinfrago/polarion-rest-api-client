...
T = TypeVar("T", bound="PostIconsRequestBody")
...
class PostIconsRequestBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = IconsListPostRequest.from_dict(_resource)

        post_icons_request_body_obj = cls(
            files=files,
            resource=resource,
        )

        post_icons_request_body_obj.additional_properties = d
