...
class FeatureselectionsSingleGetResponseDataRelationshipsWorkItem:
    """
    Attributes:
        data (FeatureselectionsSingleGetResponseDataRelationshipsWorkItemData | Unset):
    """

    data: (
        FeatureselectionsSingleGetResponseDataRelationshipsWorkItemData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        featureselections_single_get_response_data_relationships_work_item_obj.additional_properties = d
