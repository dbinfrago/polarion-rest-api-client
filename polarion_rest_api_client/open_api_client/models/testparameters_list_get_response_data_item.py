...
class TestparametersListGetResponseDataItem:
    """
    Attributes:
        type_ (TestparametersListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyTestParameter.
        revision (str | Unset):  Example: 1234.
        attributes (TestparametersListGetResponseDataItemAttributes | Unset):
        relationships (TestparametersListGetResponseDataItemRelationships | Unset):
        links (TestparametersListGetResponseDataItemLinks | Unset):
        meta (TestparametersListGetResponseDataItemMeta | Unset):
    """

    type_: TestparametersListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: TestparametersListGetResponseDataItemAttributes | Unset = UNSET
    relationships: (
        TestparametersListGetResponseDataItemRelationships | Unset
    ) = UNSET
    links: TestparametersListGetResponseDataItemLinks | Unset = UNSET
    meta: TestparametersListGetResponseDataItemMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestparametersListGetResponseDataItemType(_type_)
