...
if TYPE_CHECKING:
    from ..models.workitems_single_get_response_data_meta_errors_item_source import (
        WorkitemsSingleGetResponseDataMetaErrorsItemSource,
    )


T = TypeVar("T", bound="WorkitemsSingleGetResponseDataMetaErrorsItem")


@_attrs_define
class WorkitemsSingleGetResponseDataMetaErrorsItem:
    """
    Attributes:
        ...
        source (WorkitemsSingleGetResponseDataMetaErrorsItemSource | Unset):
    ...
    source: WorkitemsSingleGetResponseDataMetaErrorsItemSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                WorkitemsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                    _source
                )
            )
        ...
        workitems_single_get_response_data_meta_errors_item_obj.additional_properties = d
