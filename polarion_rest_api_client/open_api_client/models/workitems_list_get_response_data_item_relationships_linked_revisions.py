...
class WorkitemsListGetResponseDataItemRelationshipsLinkedRevisions:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsLinkedRevisionsDataItem] | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsLinkedRevisionsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_linked_revisions_obj.additional_properties = d
