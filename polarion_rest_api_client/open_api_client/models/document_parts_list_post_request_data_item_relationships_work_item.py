...
class DocumentPartsListPostRequestDataItemRelationshipsWorkItem:
    """
    Attributes:
        data (DocumentPartsListPostRequestDataItemRelationshipsWorkItemData | Unset):
    """

    data: (
        DocumentPartsListPostRequestDataItemRelationshipsWorkItemData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_parts_list_post_request_data_item_relationships_work_item_obj.additional_properties = d
