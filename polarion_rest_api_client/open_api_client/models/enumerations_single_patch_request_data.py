...
if TYPE_CHECKING:
    from ..models.enumerations_single_patch_request_data_attributes import (
...
class EnumerationsSinglePatchRequestData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = EnumerationsSinglePatchRequestDataType(_type_)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                EnumerationsSinglePatchRequestDataAttributes.from_dict(
                    _attributes
                )
            )

        enumerations_single_patch_request_data_obj = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        enumerations_single_patch_request_data_obj.additional_properties = d
        return enumerations_single_patch_request_data_obj
