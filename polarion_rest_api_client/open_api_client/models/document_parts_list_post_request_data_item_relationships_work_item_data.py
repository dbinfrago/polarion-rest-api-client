...
class DocumentPartsListPostRequestDataItemRelationshipsWorkItemData:
    ...
    Attributes:
        ...
        type_ (DocumentPartsListPostRequestDataItemRelationshipsWorkItemDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentPartsListPostRequestDataItemRelationshipsWorkItemDataType(
                _type_
            )
        ...
        document_parts_list_post_request_data_item_relationships_work_item_data_obj.additional_properties = d
