...
class UsersListGetResponseDataItemRelationshipsUserGroupsDataItem:
    ...
    Attributes:
        ...
        type_ (UsersListGetResponseDataItemRelationshipsUserGroupsDataItemType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        UsersListGetResponseDataItemRelationshipsUserGroupsDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_list_get_response_data_item_relationships_user_groups_data_item_obj.additional_properties = d
