...
if TYPE_CHECKING:
    from ..models.enumerations_single_patch_request_data_attributes_options_item_link_rules_item import (
...
class EnumerationsSinglePatchRequestDataAttributesOptionsItem:
    ...
    Attributes:
        ...
        link_rules (list[EnumerationsSinglePatchRequestDataAttributesOptionsItemLinkRulesItem] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _link_rules is not UNSET:
            ...
            for link_rules_item_data in _link_rules:
                link_rules_item = EnumerationsSinglePatchRequestDataAttributesOptionsItemLinkRulesItem.from_dict(
        ...
        enumerations_single_patch_request_data_attributes_options_item_obj.additional_properties = d
        return (
