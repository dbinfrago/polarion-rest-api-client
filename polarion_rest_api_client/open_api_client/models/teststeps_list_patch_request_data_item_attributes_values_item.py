...
class TeststepsListPatchRequestDataItemAttributesValuesItem:
    """
    Attributes:
        type_ (TeststepsListPatchRequestDataItemAttributesValuesItemType | Unset):
        value (str | Unset):  Example: My text value.
    """

    type_: (
        TeststepsListPatchRequestDataItemAttributesValuesItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepsListPatchRequestDataItemAttributesValuesItemType(
                _type_
            )
        ...
        teststeps_list_patch_request_data_item_attributes_values_item_obj.additional_properties = d
        return (
            teststeps_list_patch_request_data_item_attributes_values_item_obj
        )
