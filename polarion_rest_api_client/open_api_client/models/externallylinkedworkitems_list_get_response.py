...
class ExternallylinkedworkitemsListGetResponse:
    """
    Attributes:
        data (list[ExternallylinkedworkitemsListGetResponseDataItem] | Unset):
        included (list[ExternallylinkedworkitemsListGetResponseIncludedItem] | Unset): Related entities might be
            ...
            Guide</a>.
        links (ExternallylinkedworkitemsListGetResponseLinks | Unset):
        meta (ExternallylinkedworkitemsListGetResponseMeta | Unset):
    """
    ...
    included: (
        list[ExternallylinkedworkitemsListGetResponseIncludedItem] | Unset
    ) = UNSET
    links: ExternallylinkedworkitemsListGetResponseLinks | Unset = UNSET
    meta: ExternallylinkedworkitemsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: (
            list[ExternallylinkedworkitemsListGetResponseDataItem] | Unset
        ) = UNSET
        ...
        if _included is not UNSET:
            ...
            for included_item_data in _included:
                included_item = ExternallylinkedworkitemsListGetResponseIncludedItem.from_dict(
                    included_item_data
                )
        ...
        externallylinkedworkitems_list_get_response_obj.additional_properties = d
