...
class DocumentsSingleGetResponseDataRelationshipsComments:
    """
    Attributes:
        data (list[DocumentsSingleGetResponseDataRelationshipsCommentsDataItem] | Unset):
        links (DocumentsSingleGetResponseDataRelationshipsCommentsLinks | Unset):
        meta (DocumentsSingleGetResponseDataRelationshipsCommentsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_get_response_data_relationships_comments_obj.additional_properties = d
