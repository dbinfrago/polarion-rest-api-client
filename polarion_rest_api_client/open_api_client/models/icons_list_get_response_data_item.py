...
class IconsListGetResponseDataItem:
    """
    Attributes:
        type_ (IconsListGetResponseDataItemType | Unset):
        id (str | Unset):  Example: default/example.gif.
        revision (str | Unset):  Example: 1234.
        attributes (IconsListGetResponseDataItemAttributes | Unset):
        links (IconsListGetResponseDataItemLinks | Unset):
        meta (IconsListGetResponseDataItemMeta | Unset):
    """

    type_: IconsListGetResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    attributes: IconsListGetResponseDataItemAttributes | Unset = UNSET
    links: IconsListGetResponseDataItemLinks | Unset = UNSET
    meta: IconsListGetResponseDataItemMeta | Unset = UNSET
