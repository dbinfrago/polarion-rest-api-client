...
if TYPE_CHECKING:
    from ..models.document_parts_list_get_response_data_item import (
        DocumentPartsListGetResponseDataItem,
    )
    from ..models.document_parts_list_get_response_included_item import (
        DocumentPartsListGetResponseIncludedItem,
    )
    from ..models.document_parts_list_get_response_links import (
        DocumentPartsListGetResponseLinks,
    )
    from ..models.document_parts_list_get_response_meta import (
        DocumentPartsListGetResponseMeta,
    )


T = TypeVar("T", bound="DocumentPartsListGetResponse")
...
class DocumentPartsListGetResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = DocumentPartsListGetResponseMeta.from_dict(_meta)

        document_parts_list_get_response_obj = cls(
            data=data,
            included=included,
            links=links,
            meta=meta,
        ...
        document_parts_list_get_response_obj.additional_properties = d
        return document_parts_list_get_response_obj
