...
class TestrecordsListPostRequestDataItemRelationshipsDefectData:
    ...
    Attributes:
        ...
        type_ (TestrecordsListPostRequestDataItemRelationshipsDefectDataType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        TestrecordsListPostRequestDataItemRelationshipsDefectDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_post_request_data_item_relationships_defect_data_obj.additional_properties = d
