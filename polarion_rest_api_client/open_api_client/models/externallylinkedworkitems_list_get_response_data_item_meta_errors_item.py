...
T = TypeVar(
    "T", bound="ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItem"
)
...
class ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItem:
    ...
    Attributes:
        ...
        source (ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItemSource | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        externallylinkedworkitems_list_get_response_data_item_meta_errors_item_obj = cls(
            detail=detail,
            source=source,
            status=status,
            title=title,
