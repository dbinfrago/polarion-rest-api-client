...
if TYPE_CHECKING:
    from ..models.testrecords_list_post_request_data_item_attributes_comment import (
        TestrecordsListPostRequestDataItemAttributesComment,
    )


T = TypeVar("T", bound="TestrecordsListPostRequestDataItemAttributes")


@_attrs_define
class TestrecordsListPostRequestDataItemAttributes:
    """
    Attributes:
        comment (TestrecordsListPostRequestDataItemAttributesComment | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = (
                TestrecordsListPostRequestDataItemAttributesComment.from_dict(
                    _comment
                )
            )
        ...
        testrecords_list_post_request_data_item_attributes_obj = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            result=result,
        ...
        testrecords_list_post_request_data_item_attributes_obj.additional_properties = d
        return testrecords_list_post_request_data_item_attributes_obj
