...
class WorkitemsListPatchRequestDataItemAttributes:
    """
    Attributes:
        description (WorkitemsListPatchRequestDataItemAttributesDescription | Unset):
        due_date (datetime.date | Unset):  Example: 1970-01-01.
        hyperlinks (list[WorkitemsListPatchRequestDataItemAttributesHyperlinksItem] | Unset):
    ...
    description: (
        WorkitemsListPatchRequestDataItemAttributesDescription | Unset
    ) = UNSET
    due_date: datetime.date | Unset = UNSET
    hyperlinks: (
        list[WorkitemsListPatchRequestDataItemAttributesHyperlinksItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_patch_request_data_item_attributes_obj.additional_properties = d
