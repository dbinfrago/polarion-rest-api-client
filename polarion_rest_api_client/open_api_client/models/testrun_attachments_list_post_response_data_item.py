...
class TestrunAttachmentsListPostResponseDataItem:
    """
    Attributes:
        type_ (TestrunAttachmentsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyAttachmentId.
        links (TestrunAttachmentsListPostResponseDataItemLinks | Unset):
    """

    type_: TestrunAttachmentsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: TestrunAttachmentsListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunAttachmentsListPostResponseDataItemType(_type_)
        ...
        testrun_attachments_list_post_response_data_item_obj.additional_properties = d
