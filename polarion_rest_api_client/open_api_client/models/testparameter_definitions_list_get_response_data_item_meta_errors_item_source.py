...
if TYPE_CHECKING:
    from ..models.testparameter_definitions_list_get_response_data_item_meta_errors_item_source_resource import (
...
T = TypeVar(
    "T",
    bound="TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSource",
)
...
class TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSource:
    ...
    Attributes:
        ...
        resource (TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSourceResource | Unset): Resource causing
            the error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                _resource
            )
        ...
        testparameter_definitions_list_get_response_data_item_meta_errors_item_source_obj.additional_properties = d
