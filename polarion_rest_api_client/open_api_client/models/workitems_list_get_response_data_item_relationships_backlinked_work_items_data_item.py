...
class WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItemType(
                _type_
            )
