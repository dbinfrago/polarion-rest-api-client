...
T = TypeVar(
    "T", bound="WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItem"
)
...
class WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItem:
    ...
    Attributes:
        ...
        type_ (WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItemType(
                _type_
            )
        ...
        workitems_list_post_request_data_item_relationships_assignee_data_item_obj.additional_properties = d
