...
class WorkitemsListDeleteRequestDataItem:
    """
    Attributes:
        type_ (WorkitemsListDeleteRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId.
    """

    type_: WorkitemsListDeleteRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListDeleteRequestDataItemType(_type_)
