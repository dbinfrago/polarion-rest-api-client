...
class PlansSinglePatchRequestDataAttributes:
    ...
    Attributes:
        ...
        calculation_type (PlansSinglePatchRequestDataAttributesCalculationType | Unset):  Example: timeBased.
        capacity (float | Unset):
        color (str | Unset):  Example: Color.
        default_estimate (float | Unset):
        description (PlansSinglePatchRequestDataAttributesDescription | Unset):
        ...
        home_page_content (PlansSinglePatchRequestDataAttributesHomePageContent | Unset):
    ...
    calculation_type: (
        PlansSinglePatchRequestDataAttributesCalculationType | Unset
    ) = UNSET
    ...
    home_page_content: (
        PlansSinglePatchRequestDataAttributesHomePageContent | Unset
    ) = UNSET
