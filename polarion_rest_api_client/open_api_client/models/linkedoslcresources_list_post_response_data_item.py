...
class LinkedoslcresourcesListPostResponseDataItem:
    """
    Attributes:
        type_ (LinkedoslcresourcesListPostResponseDataItemType | Unset):
        ...
        links (LinkedoslcresourcesListPostResponseDataItemLinks | Unset):
    """

    type_: LinkedoslcresourcesListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: LinkedoslcresourcesListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = LinkedoslcresourcesListPostResponseDataItemType(_type_)
        ...
        linkedoslcresources_list_post_response_data_item_obj.additional_properties = d
