...
class WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItems:
    """
    Attributes:
        data (list[WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsDataItem] | Unset):
        meta (WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsMeta | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_backlinked_work_items_obj.additional_properties = d
