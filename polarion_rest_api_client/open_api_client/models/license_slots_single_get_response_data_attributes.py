...
T = TypeVar("T", bound="LicenseSlotsSingleGetResponseDataAttributes")


@_attrs_define
class LicenseSlotsSingleGetResponseDataAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        license_slots_single_get_response_data_attributes_obj = cls(
        ...
        license_slots_single_get_response_data_attributes_obj.additional_properties = d
        return license_slots_single_get_response_data_attributes_obj
