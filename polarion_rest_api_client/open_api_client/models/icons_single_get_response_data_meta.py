...
class IconsSingleGetResponseDataMeta:
    """
    Attributes:
        errors (list[IconsSingleGetResponseDataMetaErrorsItem] | Unset):
    """

    errors: list[IconsSingleGetResponseDataMetaErrorsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _errors is not UNSET:
            ...
            for errors_item_data in _errors:
                errors_item = (
                    IconsSingleGetResponseDataMetaErrorsItem.from_dict(
                        errors_item_data
                    )
                )
