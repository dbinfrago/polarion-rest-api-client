...
class TeststepsListPatchRequestDataItem:
    """
    Attributes:
        type_ (TeststepsListPatchRequestDataItemType | Unset):
        id (str | Unset):  Example: MyProjectId/MyWorkItemId/MyTestStepIndex.
        attributes (TeststepsListPatchRequestDataItemAttributes | Unset):
    """

    type_: TeststepsListPatchRequestDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: TeststepsListPatchRequestDataItemAttributes | Unset = UNSET
