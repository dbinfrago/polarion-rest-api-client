...
class PlansListGetResponseDataItemRelationshipsTemplateData:
    ...
    Attributes:
        ...
        type_ (PlansListGetResponseDataItemRelationshipsTemplateDataType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        PlansListGetResponseDataItemRelationshipsTemplateDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListGetResponseDataItemRelationshipsTemplateDataType(
                _type_
            )
        ...
        plans_list_get_response_data_item_relationships_template_data_obj.additional_properties = d
        return (
            plans_list_get_response_data_item_relationships_template_data_obj
        )
