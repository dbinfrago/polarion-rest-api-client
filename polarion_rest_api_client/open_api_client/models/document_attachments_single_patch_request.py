...
if TYPE_CHECKING:
    from ..models.document_attachments_single_patch_request_data import (
        DocumentAttachmentsSinglePatchRequestData,
    )


T = TypeVar("T", bound="DocumentAttachmentsSinglePatchRequest")


@_attrs_define
class DocumentAttachmentsSinglePatchRequest:
    """
    Attributes:
        data (DocumentAttachmentsSinglePatchRequestData | Unset):
    """

    data: DocumentAttachmentsSinglePatchRequestData | Unset = UNSET
