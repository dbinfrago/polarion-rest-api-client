...
class CollectionsSinglePatchRequestDataRelationshipsUpstreamCollectionsDataItem:
    ...
    Attributes:
        ...
        type_ (CollectionsSinglePatchRequestDataRelationshipsUpstreamCollectionsDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = CollectionsSinglePatchRequestDataRelationshipsUpstreamCollectionsDataItemType(
                _type_
            )
        ...
        collections_single_patch_request_data_relationships_upstream_collections_data_item_obj.additional_properties = d
