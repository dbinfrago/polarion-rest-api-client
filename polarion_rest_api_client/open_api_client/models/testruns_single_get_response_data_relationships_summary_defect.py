...
class TestrunsSingleGetResponseDataRelationshipsSummaryDefect:
    """
    Attributes:
        data (TestrunsSingleGetResponseDataRelationshipsSummaryDefectData | Unset):
    """

    data: (
        TestrunsSingleGetResponseDataRelationshipsSummaryDefectData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_get_response_data_relationships_summary_defect_obj.additional_properties = d
        return (
            testruns_single_get_response_data_relationships_summary_defect_obj
        )
