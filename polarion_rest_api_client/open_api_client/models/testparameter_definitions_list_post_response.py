...
T = TypeVar("T", bound="TestparameterDefinitionsListPostResponse")
...
class TestparameterDefinitionsListPostResponse:
    """
    Attributes:
        data (list[TestparameterDefinitionsListPostResponseDataItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: (
            list[TestparameterDefinitionsListPostResponseDataItem] | Unset
        ) = UNSET
        if _data is not UNSET:
            data = []
            for data_item_data in _data:
                data_item = (
                    TestparameterDefinitionsListPostResponseDataItem.from_dict(
                        data_item_data
                    )
                )
        ...
        testparameter_definitions_list_post_response_obj = cls(
            data=data,
        )
