...
if TYPE_CHECKING:
    from ..models.collections_list_post_request_data_item_relationships_upstream_collections_data_item import (
...
T = TypeVar(
    "T",
    bound="CollectionsListPostRequestDataItemRelationshipsUpstreamCollections",
)
...
class CollectionsListPostRequestDataItemRelationshipsUpstreamCollections:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_post_request_data_item_relationships_upstream_collections_obj.additional_properties = d
        return collections_list_post_request_data_item_relationships_upstream_collections_obj
