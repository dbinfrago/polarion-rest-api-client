...
class TeststepresultAttachmentsListGetResponse:
    """
    Attributes:
        data (list[TeststepresultAttachmentsListGetResponseDataItem] | Unset):
        included (list[TeststepresultAttachmentsListGetResponseIncludedItem] | Unset): Related entities might be
            ...
            Guide</a>.
        links (TeststepresultAttachmentsListGetResponseLinks | Unset):
        meta (TeststepresultAttachmentsListGetResponseMeta | Unset):
    """
    ...
    included: (
        list[TeststepresultAttachmentsListGetResponseIncludedItem] | Unset
    ) = UNSET
    links: TeststepresultAttachmentsListGetResponseLinks | Unset = UNSET
    meta: TeststepresultAttachmentsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: (
            list[TeststepresultAttachmentsListGetResponseDataItem] | Unset
        ) = UNSET
        ...
        if _included is not UNSET:
            ...
            for included_item_data in _included:
                included_item = TeststepresultAttachmentsListGetResponseIncludedItem.from_dict(
                    included_item_data
                )
        ...
        teststepresult_attachments_list_get_response_obj.additional_properties = d
