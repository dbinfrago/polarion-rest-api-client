...
class TestrunCommentsListGetResponse:
    """
    Attributes:
        data (list[TestrunCommentsListGetResponseDataItem] | Unset):
        included (list[TestrunCommentsListGetResponseIncludedItem] | Unset): Related entities might be returned, see <a
            ...
            Guide</a>.
        links (TestrunCommentsListGetResponseLinks | Unset):
        meta (TestrunCommentsListGetResponseMeta | Unset):
    """

    data: list[TestrunCommentsListGetResponseDataItem] | Unset = UNSET
    included: list[TestrunCommentsListGetResponseIncludedItem] | Unset = UNSET
    links: TestrunCommentsListGetResponseLinks | Unset = UNSET
    meta: TestrunCommentsListGetResponseMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        included: list[TestrunCommentsListGetResponseIncludedItem] | Unset = (
            UNSET
        )
