...
class WorkitemAttachmentsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_single_get_response_data_attributes_obj = cls(
            file_name=file_name,
            id=id,
            length=length,
            title=title,
        ...
        workitem_attachments_single_get_response_data_attributes_obj.additional_properties = d
        return workitem_attachments_single_get_response_data_attributes_obj
