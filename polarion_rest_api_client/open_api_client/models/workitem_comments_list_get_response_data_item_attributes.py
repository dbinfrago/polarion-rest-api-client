...
T = TypeVar("T", bound="WorkitemCommentsListGetResponseDataItemAttributes")
...
class WorkitemCommentsListGetResponseDataItemAttributes:
    ...
    Attributes:
        ...
        resolved (bool | Unset):
        text (WorkitemCommentsListGetResponseDataItemAttributesText | Unset):
    ...
    text: WorkitemCommentsListGetResponseDataItemAttributesText | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_text, Unset):
            ...
            text = WorkitemCommentsListGetResponseDataItemAttributesText.from_dict(
                _text
            )

        title = d.pop("title", UNSET)

        workitem_comments_list_get_response_data_item_attributes_obj = cls(
            created=created,
            id=id,
            resolved=resolved,
            text=text,
