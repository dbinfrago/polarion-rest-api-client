...
T = TypeVar(
    "T", bound="TeststepresultAttachmentsListGetResponseDataItemAttributes"
)


@_attrs_define
class TeststepresultAttachmentsListGetResponseDataItemAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_list_get_response_data_item_attributes_obj = cls(
            file_name=file_name,
            id=id,
            length=length,
            title=title,
        ...
        teststepresult_attachments_list_get_response_data_item_attributes_obj.additional_properties = d
