...
class DocumentPartsListGetResponseDataItemRelationshipsNextPart:
    """
    Attributes:
        data (DocumentPartsListGetResponseDataItemRelationshipsNextPartData | Unset):
    """

    data: (
        DocumentPartsListGetResponseDataItemRelationshipsNextPartData | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_parts_list_get_response_data_item_relationships_next_part_obj.additional_properties = d
