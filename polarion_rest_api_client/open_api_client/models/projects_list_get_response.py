...
class ProjectsListGetResponse:
    """
    Attributes:
        data (list[ProjectsListGetResponseDataItem] | Unset):
        included (list[ProjectsListGetResponseIncludedItem] | Unset): Related entities might be returned, see <a
            ...
            Guide</a>.
        links (ProjectsListGetResponseLinks | Unset):
        meta (ProjectsListGetResponseMeta | Unset):
    """

    data: list[ProjectsListGetResponseDataItem] | Unset = UNSET
    included: list[ProjectsListGetResponseIncludedItem] | Unset = UNSET
    links: ProjectsListGetResponseLinks | Unset = UNSET
    meta: ProjectsListGetResponseMeta | Unset = UNSET
