...
class PlansSinglePatchRequestDataRelationshipsProjectSpanDataItem:
    ...
    Attributes:
        ...
        type_ (PlansSinglePatchRequestDataRelationshipsProjectSpanDataItemType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        PlansSinglePatchRequestDataRelationshipsProjectSpanDataItemType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansSinglePatchRequestDataRelationshipsProjectSpanDataItemType(
                _type_
            )
        ...
        plans_single_patch_request_data_relationships_project_span_data_item_obj.additional_properties = d
