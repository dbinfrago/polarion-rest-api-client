...
class DocumentCommentsListPostRequestDataItemRelationshipsParentCommentData:
    ...
    Attributes:
        ...
        type_ (DocumentCommentsListPostRequestDataItemRelationshipsParentCommentDataType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentCommentsListPostRequestDataItemRelationshipsParentCommentDataType(
                _type_
            )
        ...
        document_comments_list_post_request_data_item_relationships_parent_comment_data_obj.additional_properties = d
