...
class JobsSingleGetResponseDataRelationshipsDocuments:
    """
    Attributes:
        data (list[JobsSingleGetResponseDataRelationshipsDocumentsDataItem] | Unset):
        meta (JobsSingleGetResponseDataRelationshipsDocumentsMeta | Unset):
    """

    data: (
        list[JobsSingleGetResponseDataRelationshipsDocumentsDataItem] | Unset
    ) = UNSET
    meta: JobsSingleGetResponseDataRelationshipsDocumentsMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: (
            list[JobsSingleGetResponseDataRelationshipsDocumentsDataItem]
            | Unset
        ) = UNSET
        ...
        jobs_single_get_response_data_relationships_documents_obj.additional_properties = d
