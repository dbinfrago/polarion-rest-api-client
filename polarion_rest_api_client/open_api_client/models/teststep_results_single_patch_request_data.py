...
class TeststepResultsSinglePatchRequestData:
    """
    Attributes:
        type_ (TeststepResultsSinglePatchRequestDataType | Unset):
        id (str | Unset):  Example: MyProjectId/MyTestRunId/MyProjectId/MyTestcaseId/0/1.
        attributes (TeststepResultsSinglePatchRequestDataAttributes | Unset):
    """

    type_: TeststepResultsSinglePatchRequestDataType | Unset = UNSET
    id: str | Unset = UNSET
    attributes: TeststepResultsSinglePatchRequestDataAttributes | Unset = UNSET
