...
T = TypeVar(
    "T", bound="UsersSinglePatchRequestDataRelationshipsProjectRolesDataItem"
)
...
class UsersSinglePatchRequestDataRelationshipsProjectRolesDataItem:
    ...
    Attributes:
        ...
        type_ (UsersSinglePatchRequestDataRelationshipsProjectRolesDataItemType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UsersSinglePatchRequestDataRelationshipsProjectRolesDataItemType(
                _type_
            )

        users_single_patch_request_data_relationships_project_roles_data_item_obj = cls(
            id=id,
            type_=type_,
        )
