...
class DocumentPartsSingleGetResponseDataRelationshipsWorkItemData:
    ...
    Attributes:
        ...
        type_ (DocumentPartsSingleGetResponseDataRelationshipsWorkItemDataType | Unset):
    """

    id: str | Unset = UNSET
    revision: str | Unset = UNSET
    type_: (
        DocumentPartsSingleGetResponseDataRelationshipsWorkItemDataType | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = DocumentPartsSingleGetResponseDataRelationshipsWorkItemDataType(
                _type_
            )
        ...
        document_parts_single_get_response_data_relationships_work_item_data_obj.additional_properties = d
