...
T = TypeVar(
    "T",
    bound="EnumerationsSingleGetResponseDataAttributesOptionsItemLinkRulesItem",
)


@_attrs_define
class EnumerationsSingleGetResponseDataAttributesOptionsItemLinkRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_single_get_response_data_attributes_options_item_link_rules_item_obj = cls(
            from_types=from_types,
            same_type=same_type,
            to_types=to_types,
        )

        enumerations_single_get_response_data_attributes_options_item_link_rules_item_obj.additional_properties = d
        return enumerations_single_get_response_data_attributes_options_item_link_rules_item_obj
