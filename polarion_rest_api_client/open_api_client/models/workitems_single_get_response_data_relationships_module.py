...
class WorkitemsSingleGetResponseDataRelationshipsModule:
    """
    Attributes:
        data (WorkitemsSingleGetResponseDataRelationshipsModuleData | Unset):
    """

    data: WorkitemsSingleGetResponseDataRelationshipsModuleData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_module_obj.additional_properties = d
