...
class TestrunsSinglePatchRequestDataAttributes:
    ...
    Attributes:
        ...
        home_page_content (TestrunsSinglePatchRequestDataAttributesHomePageContent | Unset):
        id_prefix (str | Unset):  Example: MyTestRunIdPrefix.
        keep_in_history (bool | Unset):
        query (str | Unset):  Example: Query.
        select_test_cases_by (TestrunsSinglePatchRequestDataAttributesSelectTestCasesBy | Unset):  Example:
            manualSelection.
    ...
    home_page_content: (
        TestrunsSinglePatchRequestDataAttributesHomePageContent | Unset
    ) = UNSET
    id_prefix: str | Unset = UNSET
    keep_in_history: bool | Unset = UNSET
    query: str | Unset = UNSET
    select_test_cases_by: (
        TestrunsSinglePatchRequestDataAttributesSelectTestCasesBy | Unset
    ) = UNSET
