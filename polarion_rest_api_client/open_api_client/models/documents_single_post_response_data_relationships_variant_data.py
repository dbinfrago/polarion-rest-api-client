...
from ..models.documents_single_post_response_data_relationships_variant_data_type import (
    DocumentsSinglePostResponseDataRelationshipsVariantDataType,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="DocumentsSinglePostResponseDataRelationshipsVariantData"
)
...
class DocumentsSinglePostResponseDataRelationshipsVariantData:
    ...
    Attributes:
        ...
        type_ (DocumentsSinglePostResponseDataRelationshipsVariantDataType | Unset):
    """

    id: str | Unset = UNSET
    type_: (
        DocumentsSinglePostResponseDataRelationshipsVariantDataType | Unset
    ) = UNSET
