...
class EnumerationsListPostResponseDataItem:
    """
    Attributes:
        type_ (EnumerationsListPostResponseDataItemType | Unset):
        id (str | Unset):  Example: ~/status/~.
        links (EnumerationsListPostResponseDataItemLinks | Unset):
    """

    type_: EnumerationsListPostResponseDataItemType | Unset = UNSET
    id: str | Unset = UNSET
    links: EnumerationsListPostResponseDataItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = EnumerationsListPostResponseDataItemType(_type_)
