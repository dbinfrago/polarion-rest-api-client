...
class TestrunAttachmentsListGetResponseDataItemRelationships:
    """
    Attributes:
        author (TestrunAttachmentsListGetResponseDataItemRelationshipsAuthor | Unset):
        project (TestrunAttachmentsListGetResponseDataItemRelationshipsProject | Unset):
    """

    author: (
        TestrunAttachmentsListGetResponseDataItemRelationshipsAuthor | Unset
    ) = UNSET
    project: (
        TestrunAttachmentsListGetResponseDataItemRelationshipsProject | Unset
    ) = UNSET
