...
class TeststepsListPostRequestDataItem:
    """
    Attributes:
        type_ (TeststepsListPostRequestDataItemType | Unset):
        attributes (TeststepsListPostRequestDataItemAttributes | Unset):
    """

    type_: TeststepsListPostRequestDataItemType | Unset = UNSET
    attributes: TeststepsListPostRequestDataItemAttributes | Unset = UNSET
