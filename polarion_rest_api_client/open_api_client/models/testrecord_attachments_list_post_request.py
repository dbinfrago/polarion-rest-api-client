...
class TestrecordAttachmentsListPostRequest:
    """
    Attributes:
        data (list[TestrecordAttachmentsListPostRequestDataItem] | Unset):
    """

    data: list[TestrecordAttachmentsListPostRequestDataItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = (
                    TestrecordAttachmentsListPostRequestDataItem.from_dict(
                        data_item_data
                    )
                )
