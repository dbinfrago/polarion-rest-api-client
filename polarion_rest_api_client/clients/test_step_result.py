...
class TestStepResults(bc.SingleGetClient[dm.TestStepResult], bc.UpdateClient[dm.TestStepResult], bc.CreateClient[dm.TestStepResult], bc.MultiGetClient[dm.TestStepResult]):
    ...
    def create(self, to_update: list[dm.TestStepResult])-> None:
    ...
    def _delete(self, items: list[dm.TestStepResult]) -> None:
    ...
    def get_multi(self, 
                  ...
                  revision: str | None = None,) -> list[dm.TestStepResult]:
    ...
    def _fill_teststep_result_attributes(
        ...
        comment_item_type = api_models.TeststepResultsSinglePatchRequestDataAttributesCommentType.TEXTPLAIN
        comment_item_cls = api_models.TeststepResultsSinglePatchRequestDataAttributesComment
        comment_value = None
    ...
    def _async_create(self, items: list[dm.TestStepResult]) -> None:
        raise NotImplementedError("async create is not implemented.")
    
    def _async_update(self, items: list[dm.TestStepResult]) -> None:
        raise NotImplementedError("async update is not implemented.")
    
    def async_get(self, items: list[dm.TestStepResult]) -> None:
        raise NotImplementedError("async get is not implemented.")
    
    def async_get_multi(self, items: list[dm.TestStepResult]) -> None:
