...
class TestStepResultAttachments(bc.SingleGetClient[dm.TestStepResultAttachment], bc.UpdateClient[dm.TestStepResultAttachment], bc.CreateClient[dm.TestStepResultAttachment], bc.MultiGetClient[dm.TestStepResultAttachment], bc.DeleteClient[dm.TestStepResultAttachment]):
    ...
    def _delete(self, *args: t.Any, **kwargs: t.Any) -> dm.WorkItemAttachment:
        """Return a specific attachment - not Implemented yet."""
        raise NotImplementedError

    def _update(self, *args: t.Any, **kwargs: t.Any) -> dm.WorkItemAttachment:
        """Return a specific attachment - not Implemented yet."""
        raise NotImplementedError

    def get_multi(
        self,
        items: list[dm.TestStepResultAttachment],
        *,
        page_size: int = 100,
        page_number: int = 1,
            ...
            for attachment in parsed_response.data:
                ...
                teststepResult_attachments.append(
                    dm.TestStepResultAttachment(
                        items[0].test_run_id,
                        items[0].test_case_project_id,
                        items[0].test_case_id,
                        items[0].test_step_index,
                        items[0].iteration,
    ...
    def _async_create(self, *args: t.Any, **kwargs: t.Any) -> None:
        """Create the given work item attachment in Polarion - not Implemented yet."""
        raise NotImplementedError
    
    def _async_update(self, *args: t.Any, **kwargs: t.Any) -> None:
        """Update the given work item attachment in Polarion - not Implemented yet."""
        raise NotImplementedError
    
    def _async_delete(self, *args: t.Any, **kwargs: t.Any) -> None:
        """Delete the given teststep result attachment - not Implemented yet."""
        raise NotImplementedError
    
    def async_get_multi(self, *args: t.Any, **kwargs: t.Any) -> dm.TestStepResultAttachment:
        """Return a specific attachment - not Implemented yet."""
        raise NotImplementedError