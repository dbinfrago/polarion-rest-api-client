...
TEST_TSRES_NO_NEXT_RESPONSE = (
    TEST_RESPONSES / "test_step_results_no_next_page.json"
)
...
TEST_TSRES_ATT_CREATED_RESPONSE = (
    TEST_RESPONSES / "created_test_step_result_attachments.json"
)
TEST_TSRES_ATT_NO_NEXT_RESPONSE = (
    TEST_RESPONSES / "test_step_result_attachments_no_next_page.json"
)

TEST_TS_RESULTS_CREATED_RESPONSE = (
    TEST_RESPONSES / "created_test_step_results.json"
)
TEST_TS_RESULTS_NEXT_RESPONSE = (
    TEST_RESPONSES / "get_test_step_results_next_page.json"
)
TEST_TS_RESULTS_NO_NEXT_RESPONSE = (
    TEST_RESPONSES / "get_test_step_results_no_next_page.json"
)
...
TEST_TS_RESULT_ATTACHMENTS_NEXT_RESPONSE = (
    TEST_RESPONSES / "get_test_step_result_attachments_next_page.json"
)
TEST_TS_RESULT_ATTACHMENTS_NO_NEXT_RESPONSE = (
    TEST_RESPONSES / "get_test_step_result_attachments_no_next_page.json"
)
